...
date_to_analyze = (today - BDay(2)).strftime("%d%m%Y")
penultimate_date_to_analyze = str((today - BDay(2) - timedelta(1)).strftime("%d%m%Y"))
#date_to_analyze = '07062021'
#penultimate_date_to_analyze = '06062021'
...
#def fill_na_in_side01_ids_row_apply(param_row):
#	side0_val = param_row['ViewData.Side0_UniqueIds']
#	side1_val = param_row['ViewData.Side1_UniqueIds']
#	if(side0_val is None):
...
db_1_for_MEO_data = mngdb_obj_1_for_reading_and_writing_in_uat_server.client['ReconDB']
...
query_1_for_MEO_data = db_1_for_MEO_data['RecData_' + setup_code].find({ 
																	 ...
																	 "ViewData.Business Date" : '06-07-2021'
															 },
                                                             {
                                                                     "DataSides" : 1,
                                                                     "BreakID" : 1,
