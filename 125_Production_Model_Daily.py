...
#    print('Introducing error' + str(asdas))
    ...
    cols = ['Currency', 'Account Type', 'Accounting Net Amount',
            ...
            'Mapped Custodian Account', 'Net Amount Difference', 'Net Amount Difference Absolute',
            ...
            # 'Strike Price',
            'System Comments', 'Ticker', 'Trade Date', 'Trade Expenses', 'Transaction Category', 'Transaction ID',
            'Transaction Type',
            'Underlying Cusip', 'Underlying Investment ID', 'Underlying ISIN', 'Underlying Sedol', 'Underlying Ticker',
            'Source Combination', '_ID']
    # 'UnMapped']
    ...
    def get_BreakID_from_list_of_Side_01_UniqueIds(fun_str_list_Side_01_UniqueIds, fun_meo_df, fun_side_0_or_1):
        ...
        for str_element_Side_01_UniqueIds in fun_str_list_Side_01_UniqueIds:
            if (fun_side_0_or_1 == 0):
                element_BreakID_corresponding_to_Side_01_UniqueIds = \
                fun_meo_df[fun_meo_df['ViewData.Side0_UniqueIds'].isin([str_element_Side_01_UniqueIds])][
                    'ViewData.BreakID'].unique()
                list_BreakID_corresponding_to_Side_01_UniqueIds.append(
                    element_BreakID_corresponding_to_Side_01_UniqueIds[0])
            elif (fun_side_0_or_1 == 1):
                element_BreakID_corresponding_to_Side_01_UniqueIds = \
                fun_meo_df[fun_meo_df['ViewData.Side1_UniqueIds'].isin([str_element_Side_01_UniqueIds])][
                    'ViewData.BreakID'].unique()
                list_BreakID_corresponding_to_Side_01_UniqueIds.append(
                    element_BreakID_corresponding_to_Side_01_UniqueIds[0])
    ...
    def get_first_non_null_value(string_of_values_separated_by_comma):
        if (
                string_of_values_separated_by_comma != '' and string_of_values_separated_by_comma != 'nan' and string_of_values_separated_by_comma != 'None'):
            if (string_of_values_separated_by_comma.partition(',')[0] != '' and
                    string_of_values_separated_by_comma.partition(',')[0] != 'nan' and
                    string_of_values_separated_by_comma.partition(',')[0] != 'None'):
    ...
    def make_Side0_Side1_columns_for_final_smb_ob_table(fun_final_smb_ob_table, fun_meo_df):
        fun_final_smb_ob_table = pd.merge(fun_final_smb_ob_table,
                                          fun_meo_df[['ViewData.BreakID', 'ViewData.Side0_UniqueIds']],
                                          left_on='BreakID_OB', right_on='ViewData.BreakID')
        ...
        fun_final_smb_ob_table = pd.merge(fun_final_smb_ob_table,
                                          fun_meo_df[['ViewData.BreakID', 'ViewData.Side1_UniqueIds']],
                                          left_on='BreakID_OB', right_on='ViewData.BreakID')
        fun_final_smb_ob_table.drop('ViewData.BreakID', axis=1, inplace=True)
        ...
        fun_final_smb_ob_table = pd.merge(fun_final_smb_ob_table,
                                          fun_meo_df[['ViewData.BreakID', 'ViewData.Side0_UniqueIds']],
                                          left_on='BreakID_SMB', right_on='ViewData.BreakID')
        fun_final_smb_ob_table.drop('ViewData.BreakID', axis=1, inplace=True)
        ...
        fun_final_smb_ob_table['Side0_UniqueIds'] = fun_final_smb_ob_table.apply(
            lambda row: make_Side0_Side1_columns_for_final_smb_ob_table_row_apply(row, fun_side=0), axis=1,
            result_type="expand")
        fun_final_smb_ob_table['Side1_UniqueIds'] = fun_final_smb_ob_table.apply(
            lambda row: make_Side0_Side1_columns_for_final_smb_ob_table_row_apply(row, fun_side=1), axis=1,
            result_type="expand")
        ...
        fun_final_smb_ob_table.drop(
            ['Side0_UniqueIds_OB', 'Side1_UniqueIds_OB', 'Side0_UniqueIds_SMB', 'Side1_UniqueIds_SMB'], axis=1,
            inplace=True)

        return (fun_final_smb_ob_table)


    def get_NetAmountDifference_for_BreakIds_from_BreakID_and_FinalPredictedBreakID_column_apply_row(fun_row,
                                                                                                     fun_meo_df):
        lst_Net_Amount_Difference_list_for_FinalPredictedBreak = list(
            fun_meo_df[fun_meo_df['ViewData.BreakID'].isin(fun_row['Final_predicted_break'].split(', '))][
                'ViewData.Net Amount Difference'].unique())
        lst_Net_Amount_Difference_list_for_BreakID = list(
            fun_meo_df[fun_meo_df['ViewData.BreakID'].isin(fun_row['BreakID'].split(', '))][
                'ViewData.Net Amount Difference'].unique())
    ...
    def find_BreakID_and_other_cols_in_meo_for_Side_0_1_UniqueIds_value(fun_string_value_of_Side_0_1_UniqueIds,
                                                                        fun_meo_df, fun_side, fun_other_cols_list=None):
        if fun_other_cols_list is None:
            all_cols_to_find = ['ViewData.BreakID']
        else:
            all_cols_to_find = fun_other_cols_list + ['ViewData.BreakID']
        if (fun_side == 0):
            return (fun_meo_df[fun_meo_df['ViewData.Side0_UniqueIds'] == fun_string_value_of_Side_0_1_UniqueIds][
                all_cols_to_find])
        elif (fun_side == 1):
            return (fun_meo_df[fun_meo_df['ViewData.Side1_UniqueIds'] == fun_string_value_of_Side_0_1_UniqueIds][
                all_cols_to_find])
        else:
            return 0
    ...
    def contains_multiple_values_in_either_Side_0_or_1_UniqueIds_for_expected_single_sided_status(fun_row):
        ...
        if ((str(fun_row['ViewData.Status']) in ['OB', 'SDB', 'UOB', 'CNF', 'CMF']) and (
                (Side_0_contains_comma == 1) or (Side_1_contains_comma == 1))):
            return ('remove')
        else:
            return ('keep')


    def find_Side_0_1_UniqueIds_and_other_cols_in_meo_for_BreakID_value(fun_string_value_of_BreakID, fun_meo_df,
                                                                        fun_other_cols_list=None):
        if fun_other_cols_list is None:
            all_cols_to_find = ['ViewData.Side0_UniqueIds', 'ViewData.Side1_UniqueIds', 'ViewData.Status']
        else:
            all_cols_to_find = fun_other_cols_list + ['ViewData.Side0_UniqueIds', 'ViewData.Side1_UniqueIds',
                                                      'ViewData.Status']
    ...
    def assign_Transaction_Type_for_closing_apply_row(fun_row,
                                                      fun_transaction_type_col_name='ViewData.Transaction Type'):
        ...
        elif (fun_row[fun_transaction_type_col_name] in ['TRF FM MARGIN MARK TO MARKET',
                                                         'TRF TO SHORT MARK TO MARKET']):
            Transaction_Type_for_closing = 'TRF_FM_SHORT_MARK_TO_MARKET'
    ...
    def assign_Transaction_Type_for_closing_apply_row_2(fun_row,
                                                        fun_transaction_type_col_name='ViewData.Transaction Type2'):
    ...
    def cleaned_meo(  # fun_filepath_meo,
        ...
        meo['PB_or_Acct_Side'] = meo.apply(lambda row: assign_PB_Acct_side_row_apply(fun_row=row), axis=1,
                                           result_type="expand")
        meo['ViewData.Transaction Type'] = meo['ViewData.Transaction Type'].astype(str)
        meo['Transaction_Type_for_closing'] = meo.apply(
            lambda row: assign_Transaction_Type_for_closing_apply_row(fun_row=row,
                                                                      fun_transaction_type_col_name='ViewData.Transaction Type'),
            axis=1, result_type="expand")
        meo['ViewData.Transaction Type2'] = meo['ViewData.Transaction Type']
        meo['Transaction_Type_for_closing_2'] = meo.apply(
            lambda row: assign_Transaction_Type_for_closing_apply_row_2(fun_row=row,
                                                                        fun_transaction_type_col_name='ViewData.Transaction Type2'),
            axis=1, result_type="expand")
    ...
    def interacting_closing_125(fun_df):
        ...
        fun_df['filter'] = fun_df['ViewData.Source Combination Code'] + fun_df['ViewData.Mapped Custodian Account'] + \
                           fun_df['ViewData.Currency'] + fun_df['abs_net_amount_difference']
        ...
        merged_df_with_filter_counts_ge_1 = merged_df_with_filter_counts[
            merged_df_with_filter_counts['counts_for_filter'] > 1]
    ...
    def All_combination_file(fun_df):
        ...
        for key in (list(np.unique(np.array(list(fun_df['filter_key'].values))))):
            ...
            if all_training_df_for_transaction_type_filter_slice.empty == False:
                ...
                all_training_df_for_transaction_type_filter_slice = all_training_df_for_transaction_type_filter_slice.drop(
                    'index', 1)

                all_training_df_for_transaction_type_filter_joined = pd.merge(
                    all_training_df_for_transaction_type_filter_slice,
    ...
    def identifying_closed_breaks(fun_all_meo_combination_df, fun_setup_code_crucial, fun_trans_type_1,
                                  fun_trans_type_2):
            ...
            if (fun_setup_code_crucial == '125'):
                ...
                Matching_closed_break_df_1 = \
                    fun_all_meo_combination_df[ \
                        (fun_all_meo_combination_df['ViewData.Transaction Type_x'].astype(str).isin(
                            [fun_trans_type_1])) & \
                        (fun_all_meo_combination_df['ViewData.Transaction Type_y'].astype(str).isin(
                            [fun_trans_type_2])) & \
                        ...
                        (abs(fun_all_meo_combination_df['ViewData.Net Amount Difference_x']).astype(str) == abs(
                            fun_all_meo_combination_df['ViewData.Net Amount Difference_y']).astype(str)) & \
                        (fun_all_meo_combination_df['ViewData.BreakID_x'].astype(str) != fun_all_meo_combination_df[
                            'ViewData.BreakID_y'].astype(str)) \
                        ]
                ...
                # Added on 27-12-202 to catch Tran Type = ForwardFX for Mapped Custodian Account values of UBS_UBFX_ON and UBS_UBFX_OP
                if ((fun_trans_type_1 == 'ForwardFX') & (
                        fun_all_meo_combination_df['ViewData.Mapped Custodian Account_x'].iloc[0] in ['UBS_UBFX_ON',
                                                                                                      'UBS_UBFX_OP'])):
    ...
    def make_Side0_Side1_columns_for_final_smb_or_umb_ob_table(fun_final_smb_or_umb_ob_table, fun_meo_df,
                                                               fun_umb_or_smb_flag):
        ...
        fun_final_smb_or_umb_ob_table = pd.merge(fun_final_smb_or_umb_ob_table,
                                                 fun_meo_df[['ViewData.BreakID', 'ViewData.Side0_UniqueIds']],
                                                 left_on='BreakID_OB', right_on='ViewData.BreakID')
        ...
        fun_final_smb_or_umb_ob_table = pd.merge(fun_final_smb_or_umb_ob_table,
                                                 fun_meo_df[['ViewData.BreakID', 'ViewData.Side0_UniqueIds']],
                                                 left_on=BreakID_smb_umb_col_name, right_on='ViewData.BreakID')
        fun_final_smb_or_umb_ob_table.drop('ViewData.BreakID', axis=1, inplace=True)
        fun_final_smb_or_umb_ob_table.rename(columns={'ViewData.Side0_UniqueIds': Side0_UniqueIds_col_name},
                                             inplace=True)
        ...
        fun_final_smb_or_umb_ob_table = pd.merge(fun_final_smb_or_umb_ob_table,
                                                 ...
                                                 left_on=BreakID_smb_umb_col_name, right_on='ViewData.BreakID')
        fun_final_smb_or_umb_ob_table.drop('ViewData.BreakID', axis=1, inplace=True)
        fun_final_smb_or_umb_ob_table.rename(columns={'ViewData.Side1_UniqueIds': Side1_UniqueIds_col_name},
                                             inplace=True)

        fun_final_smb_or_umb_ob_table['Side0_UniqueIds_OB'] = fun_final_smb_or_umb_ob_table[
            'Side0_UniqueIds_OB'].astype(str)
        fun_final_smb_or_umb_ob_table['Side1_UniqueIds_OB'] = fun_final_smb_or_umb_ob_table[
            'Side1_UniqueIds_OB'].astype(str)
        fun_final_smb_or_umb_ob_table[Side0_UniqueIds_col_name] = fun_final_smb_or_umb_ob_table[
            Side0_UniqueIds_col_name].astype(str)
        fun_final_smb_or_umb_ob_table[Side1_UniqueIds_col_name] = fun_final_smb_or_umb_ob_table[
            Side1_UniqueIds_col_name].astype(str)

        fun_final_smb_or_umb_ob_table['Side0_UniqueIds_OB'] = fun_final_smb_or_umb_ob_table[
            'Side0_UniqueIds_OB'].replace('None', '')
        fun_final_smb_or_umb_ob_table['Side1_UniqueIds_OB'] = fun_final_smb_or_umb_ob_table[
            'Side1_UniqueIds_OB'].replace('None', '')
        fun_final_smb_or_umb_ob_table[Side0_UniqueIds_col_name] = fun_final_smb_or_umb_ob_table[
            Side0_UniqueIds_col_name].replace('None', '')
        fun_final_smb_or_umb_ob_table[Side1_UniqueIds_col_name] = fun_final_smb_or_umb_ob_table[
            Side1_UniqueIds_col_name].replace('None', '')

        fun_final_smb_or_umb_ob_table['Side0_UniqueIds_OB'] = fun_final_smb_or_umb_ob_table[
            'Side0_UniqueIds_OB'].replace('nan', '')
        fun_final_smb_or_umb_ob_table['Side1_UniqueIds_OB'] = fun_final_smb_or_umb_ob_table[
            'Side1_UniqueIds_OB'].replace('nan', '')
        fun_final_smb_or_umb_ob_table[Side0_UniqueIds_col_name] = fun_final_smb_or_umb_ob_table[
            Side0_UniqueIds_col_name].replace('nan', '')
        fun_final_smb_or_umb_ob_table[Side1_UniqueIds_col_name] = fun_final_smb_or_umb_ob_table[
            Side1_UniqueIds_col_name].replace('nan', '')

        fun_final_smb_or_umb_ob_table['Side0_UniqueIds'] = fun_final_smb_or_umb_ob_table.apply(
            lambda row: make_Side0_Side1_columns_for_final_smb_ob_or_umb_ob_table_row_apply(row, fun_side=0,
                                                                                            fun_umb_or_smb_flag=flag_value),
            axis=1, result_type="expand")
        fun_final_smb_or_umb_ob_table['Side1_UniqueIds'] = fun_final_smb_or_umb_ob_table.apply(
            lambda row: make_Side0_Side1_columns_for_final_smb_ob_or_umb_ob_table_row_apply(row, fun_side=1,
                                                                                            fun_umb_or_smb_flag=flag_value),
            axis=1, result_type="expand")
        ...
        fun_final_smb_or_umb_ob_table.drop(
            ['Side0_UniqueIds_OB', 'Side1_UniqueIds_OB', Side0_UniqueIds_col_name, Side1_UniqueIds_col_name], axis=1,
            inplace=True)
...
#        s2_out = '1251487827|Weiss Advisors|Cash|RecData_125|132120|Recon Run Completed|125|609a34b91e9c9c19c0cbc1e3'
...
#                Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Started for loop')
                ...
                print('Starting predictions for Weiss, setup_code = ' + str(setup_code) + ' and Task ID = ',
                      str(TaskID_z))
                print(setup_code)
...
#                    rb_mq_obj_new_for_publish.fun_publish_single_message(param_message_body=Message_z)
                    ...
                    if (umb_carry_forward_df.shape[0] != 0):
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='umb carry forward not empty, making umb carry forward file')
                        ...
                        umb_carry_forward_df[umb_carry_forward_columns_to_select_from_meo_df] = umb_carry_forward_df[
                            umb_carry_forward_columns_to_select_from_meo_df].astype(str)
                        ...
                        umb_carry_forward_df.rename(columns=change_names_of_umb_carry_forward_df_mapping_dict,
                                                    inplace=True)

                        umb_carry_forward_df['BusinessDate'] = pd.to_datetime(umb_carry_forward_df['BusinessDate'])
                        umb_carry_forward_df['BusinessDate'] = umb_carry_forward_df['BusinessDate'].map(
                        ...
                        umb_carry_forward_df['Final_predicted_break'] = umb_carry_forward_df[
                            'Final_predicted_break'].astype(str)
                        umb_carry_forward_df['Predicted_action'] = umb_carry_forward_df['Predicted_action'].astype(str)
                        umb_carry_forward_df['probability_No_pair'] = umb_carry_forward_df[
                            'probability_No_pair'].astype(str)
                        ...
                        umb_carry_forward_df['SourceCombinationCode'] = umb_carry_forward_df[
                            'SourceCombinationCode'].astype(str)
...
#                        filepaths_umb_carry_forward_df = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\umb_carry_forward_df_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                    ...
                    if (ob_carry_forward_df.shape[0] != 0):
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='ob carry forward not empty, not making umb carry forward file')
                        ...
                        ob_carry_forward_df[umb_carry_forward_columns_to_select_from_meo_df] = ob_carry_forward_df[
                            umb_carry_forward_columns_to_select_from_meo_df].astype(str)
                        ...
                        ob_carry_forward_df.rename(columns=change_names_of_ob_carry_forward_df_mapping_dict,
                                                   inplace=True)

                        ob_carry_forward_df['BusinessDate'] = pd.to_datetime(ob_carry_forward_df['BusinessDate'])
                        ob_carry_forward_df['BusinessDate'] = ob_carry_forward_df['BusinessDate'].map(
                            lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                        ob_carry_forward_df['BusinessDate'] = pd.to_datetime(ob_carry_forward_df['BusinessDate'])
                        ...
                        ob_carry_forward_df['Final_predicted_break'] = ob_carry_forward_df[
                            'Final_predicted_break'].astype(str)
                        ob_carry_forward_df['Predicted_action'] = ob_carry_forward_df['Predicted_action'].astype(str)
                        ob_carry_forward_df['probability_No_pair'] = ob_carry_forward_df['probability_No_pair'].astype(
                            str)
                        ...
                        ob_carry_forward_df['SourceCombinationCode'] = ob_carry_forward_df[
                            'SourceCombinationCode'].astype(str)
...
#                        filepaths_ob_carry_forward_df = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\ob_carry_forward_df_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                    ...
                    meo2['ViewData.Net Amount Difference Absolute'] = np.round(
                        meo2['ViewData.Net Amount Difference Absolute'], 2)

                    abs_amount_count = meo2['ViewData.Net Amount Difference Absolute'].value_counts().reset_index()

                    duplicate_amount = abs_amount_count[
                        abs_amount_count['ViewData.Net Amount Difference Absolute'] == 2]
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before carrying out SMB-OB operation')

                    if duplicate_amount.shape[0] > 0:
                        meo3 = meo2[meo2['ViewData.Net Amount Difference Absolute'].isin(
                            duplicate_amount['ViewData.Net Amount Difference Absolute'].unique())]
                        meo3 = meo3.reset_index().drop('index', 1)
                        meo3 = meo3.sort_values(by='ViewData.Net Amount Difference Absolute')
                        meo3 = meo3.reset_index().drop('index', 1)

                        smb_amount = meo3[meo3['ViewData.Status'].isin(['SMB'])][
                            'ViewData.Net Amount Difference Absolute'].unique()
                        umb_amount = meo3[meo3['ViewData.Status'].isin(['UMB'])][
                            'ViewData.Net Amount Difference Absolute'].unique()
                        ...
                        ob_breakid = []
                        smb_breakid = []
                        if(smb_amount.size != 0):

                            for amount in smb_amount:
                                ob = smb_ob_table[(smb_ob_table['ViewData.Net Amount Difference Absolute'] == amount) & (
                                            smb_ob_table['ViewData.Status'] == 'OB')]
                                smb = smb_ob_table[(smb_ob_table['ViewData.Net Amount Difference Absolute'] == amount) & (
                                        smb_ob_table['ViewData.Status'] == 'SMB')]
                                ...
                                if ob.shape[0] == 1 and smb.shape[0] == 1:
                                    if ((ob['ViewData.Mapped Custodian Account'].iloc[0] ==
                                         smb['ViewData.Mapped Custodian Account'].iloc[0]) and (
                                            ob['ViewData.Currency'].iloc[0] == smb['ViewData.Currency'].iloc[0]) and (
                                            ob['ViewData.Source Combination'].iloc[0] ==
                                            smb['ViewData.Source Combination'].iloc[0])):
                                        ob_breakid.append(ob['ViewData.BreakID'].values)
                                        smb_breakid.append(smb['ViewData.BreakID'].values)
                        else:
                            ob = pd.DataFrame()
                        ...
                        if len(ob_breakid) > 0:
                            ...
                            final_smb_ob_table['BreakID_SMB'] = final_smb_ob_table['BreakID_SMB'].apply(
                    ...
                    if (final_smb_ob_table.shape[0] != 0):
                        ...
                        final_smb_ob_table_BreakID_list = list(final_smb_ob_table['BreakID_OB']) + list(
                            final_smb_ob_table['BreakID_SMB'])
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After carrying out SMB-OB operation')
                    ...
                    ob_breakid = []
                    umb_breakid = []
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before carrying out UMB-OB operation')

                    if(umb_amount.size != 0):

                        for amount in umb_amount:
                            ob = umb_ob_table[(umb_ob_table['ViewData.Net Amount Difference Absolute'] == amount) & (
                                        umb_ob_table['ViewData.Status'] == 'OB')]
                            umb = umb_ob_table[(umb_ob_table['ViewData.Net Amount Difference Absolute'] == amount) & (
                                        umb_ob_table['ViewData.Status'] == 'UMB')]
                            #         if((ob.shape[0]==1) and (smb.shape[0]==1) and (ob['ViewData.Mapped Custodian Account'] == smb['ViewData.Mapped Custodian Account']) and (ob['ViewData.Currency'] == smb['ViewData.Currency']) and (ob['ViewData.Source Combination Code'] == smb['ViewData.Source Combination Code'])):
    
                            if ob.shape[0] == 1 and umb.shape[0] == 1:
                                # Change added on 17-12-2020 by Rohit to include filter on ob and smb. Below if statement is commented out and new if statement is included
                                if (('ViewData.Source Combination Code' in list(ob.columns)) & (
                                        'ViewData.Source Combination Code' in list(umb.columns))):
                                    if ((ob['ViewData.Mapped Custodian Account'].iloc[0] ==
                                         umb['ViewData.Mapped Custodian Account'].iloc[0]) and (
                                            ob['ViewData.Currency'].iloc[0] == umb['ViewData.Currency'].iloc[0]) and (
                                            ob['ViewData.Source Combination Code'].iloc[0] ==
                                            umb['ViewData.Source Combination Code'].iloc[0])):
                                        ob_breakid.append(ob['ViewData.BreakID'].values)
                                        umb_breakid.append(umb['ViewData.BreakID'].values)
                                else:
                                    if ((ob['ViewData.Mapped Custodian Account'].iloc[0] ==
                                         umb['ViewData.Mapped Custodian Account'].iloc[0]) and (
                                            ob['ViewData.Currency'].iloc[0] == umb['ViewData.Currency'].iloc[0])):
                                        ob_breakid.append(ob['ViewData.BreakID'].values)
                                        umb_breakid.append(umb['ViewData.BreakID'].values)
                    ...
                    if len(ob_breakid) > 0:
                        ...
                        final_umb_ob_table['BreakID_UMB'] = final_umb_ob_table['BreakID_UMB'].apply(
                            lambda x: str(x).replace("[", ''))
                        final_umb_ob_table['BreakID_UMB'] = final_umb_ob_table['BreakID_UMB'].apply(
                            lambda x: str(x).replace("]", ''))
                    ...
                    if (final_umb_ob_table.shape[0] != 0):
                        ...
                        final_umb_ob_table_BreakID_list = list(final_umb_ob_table['BreakID_OB']) + list(
                            final_umb_ob_table['BreakID_UMB'])
                    ...
                    if (final_umb_ob_table.shape[0] != 0):
                        ...
                        final_umb_ob_table_copy = pd.merge(final_umb_ob_table, meo_df[
                            ['ViewData.BreakID', 'ViewData.Task ID', 'ViewData.Task Business Date',
                             'ViewData.Source Combination Code']].drop_duplicates(), left_on='BreakID_OB',
                                                           right_on='ViewData.BreakID', how='left')
                        ...
                        final_umb_ob_table_copy['ViewData.Task Business Date'] = pd.to_datetime(
                            final_umb_ob_table_copy['ViewData.Task Business Date'])
                        final_umb_ob_table_copy['ViewData.Task Business Date'] = final_umb_ob_table_copy[
                            'ViewData.Task Business Date'].map(lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                        final_umb_ob_table_copy['ViewData.Task Business Date'] = pd.to_datetime(
                            final_umb_ob_table_copy['ViewData.Task Business Date'])
                        final_umb_ob_table_copy = make_Side0_Side1_columns_for_final_smb_or_umb_ob_table(
                            final_umb_ob_table_copy, meo_df, 'UMB')
...
#                        filepaths_final_umb_ob_table_copy = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_umb_ob_table_copy_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After carrying out UMB-OB operation')

                    start_closed = timeit.default_timer()
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before carrying out closed')
                    ...
                    for transaction_type_for_closing_value in mapping_dict_trans_type:
                        if (meo_for_closed[
                            ...
                            meo_for_transaction_type_for_closing_value = interacting_closing_125(
                                meo_for_transaction_type_for_closing_value_input)
                            All_combination_df = All_combination_file(fun_df=meo_for_transaction_type_for_closing_value)
                            if (All_combination_df.shape[0] != 0):
                                closed_df_for_transaction_type_for_closing_value = identifying_closed_breaks(
                                    fun_all_meo_combination_df=All_combination_df, \
                    ...
                    if (meo_for_closed[
                        meo_for_closed['Transaction_Type_for_closing_2'] == 'SPEC_Stk_Loan_Jrl_WTH'].shape[0] != 0):
                        meo_for_SPEC_Stk_Loan_Jrl_WTH_input = meo_for_closed[
                            meo_for_closed['Transaction_Type_for_closing_2'] == 'SPEC_Stk_Loan_Jrl_WTH']
                        meo_for_SPEC_Stk_Loan_Jrl_WTH = interacting_closing_125(meo_for_SPEC_Stk_Loan_Jrl_WTH_input)
                        All_combination_df_SPEC_Stk_Loan_Jrl_WTH = All_combination_file(
                            fun_df=meo_for_SPEC_Stk_Loan_Jrl_WTH)
                        closed_df_SPEC_Stk_Loan_Jrl_WTH = identifying_closed_breaks(
                            fun_all_meo_combination_df=All_combination_df_SPEC_Stk_Loan_Jrl_WTH, \
                    ...
                    all_breakids_fees_and_comm = list(
                        meo_for_closed[meo_for_closed['ViewData.Transaction Type'] == 'Fees & Comm'][
                            'ViewData.BreakID'])

                    all_breakids_beginning_with_X = list(meo_for_closed[
                                                             meo_for_closed['ViewData.Transaction Type'].isin(
                                                                 ['XBCOVER', 'XBUY', 'XSELL', 'XSSHORT'])][
                                                             'ViewData.BreakID'])

                    all_breakids_transfer_UBFX = list(meo_for_closed[(
                                (meo_for_closed['ViewData.Transaction Type'].isin(['Transfer'])) & (
                                    meo_for_closed['ViewData.Prime Broker'] == 'UBFX'))]['ViewData.BreakID'])
                    ...
                    all_predicted_closed_nan = list(meo_for_closed[(
                                (meo_for_closed['ViewData.Transaction Type'].isin(['nan', 'None', ''])) & (
                            meo_for_closed['ViewData.Mapped Custodian Account'].isin(['UBS_UBFX_ON', 'UBS_UBFX_OP'])))][
                                                        'ViewData.BreakID'])
                    ...
                    if (len(int_all_predicted_close_breakids) != 0):
                        closed_new_breakid_side01_ids_df2 = \
                        meo_df[meo_df['ViewData.BreakID'].isin(int_all_predicted_close_breakids)][
                            ['ViewData.BreakID', 'ViewData.Side0_UniqueIds', 'ViewData.Side1_UniqueIds']]
                        closed_new_breakid_side01_ids_df2[
                            'Side0_1_UniqueIds'] = closed_new_breakid_side01_ids_df2.apply(
                            lambda row: make_Side01_UniqueIds_apply_row(fun_row=row), axis=1, result_type="expand")
                        Side_0_1_UniqueIds_closed_all_dates_list = closed_new_breakid_side01_ids_df2[
                            'Side0_1_UniqueIds'].tolist()
                    else:
                        Side_0_1_UniqueIds_closed_all_dates_list = []
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After carrying out closed')
                    ...
                    df.loc[df['ViewData.Side0_UniqueIds']=='None','flag_side0'] = 0
                    df.loc[df['ViewData.Side1_UniqueIds']=='None','flag_side1'] = 0
                    
                    
                    df.loc[df['ViewData.Side0_UniqueIds']=='','flag_side0'] = 0
                    df.loc[df['ViewData.Side1_UniqueIds']=='','flag_side1'] = 0
                    ...
                    sample.loc[sample['Trans_side'] == 'A_side', 'ViewData.B-P Currency'] = sample.loc[
                        sample['Trans_side'] == 'A_side', 'ViewData.Currency']
                    sample.loc[sample['Trans_side'] == 'B_side', 'ViewData.Accounting Currency'] = sample.loc[
                        sample['Trans_side'] == 'B_side', 'ViewData.Currency']
                    ...
                    sample['ViewData.Mapped Custodian Account'] = sample['ViewData.Mapped Custodian Account'].astype(
                        str)
                    # sample['ViewData.Mapped Custodian Account'] = sample['ViewData.Mapped Custodian Account'].astype(str)
                    sample['filter_key'] = sample.apply(
                        lambda x: x['ViewData.Mapped Custodian Account'] + x['ViewData.B-P Currency'] if x[
                                                                                                             'Trans_side'] == 'A_side' else
                        x['ViewData.Mapped Custodian Account'] + x['ViewData.Accounting Currency'], axis=1)

                    sample1 = sample[(sample['flag_side0'] <= 1) & (sample['flag_side1'] <= 1) & (
                        sample['ViewData.Status'].isin(['OB', 'SPM', 'SDB', 'UDB', 'UOB', 'SMB-OB', 'CNF', 'CMF']))]
                    ...
                    aa['filter_key'] = aa['ViewData.Source Combination'].astype(str) + aa[
                        'ViewData.Mapped Custodian Account'].astype(str) + aa['ViewData.B-P Currency'].astype(str)

                    bb['filter_key'] = bb['ViewData.Source Combination'].astype(str) + bb[
                        'ViewData.Mapped Custodian Account'].astype(str) + bb['ViewData.Accounting Currency'].astype(
                        str)
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before catching mtm for revenue, expense and stock loan')
                    ...
                    def revenue_stock(tt):
                        tt = tt.lower()
                        if tt == 'revenue' or tt == 'expenses' or any(key in tt for key in
                                                                      ['stock loan fee', 'interest on short credit',
                                                                       'interest charged on debit ',
                    ...
                    if fff2.empty == False:
                        for key in fff2['filter_key'].unique():
                            ...
                            # print(key)
                            if (-0.1 <= fff2_dummy['ViewData.Net Amount Difference'].sum() < 0.1) & (
                                    fff2_dummy.shape[0] > 2) & (fff2_dummy['Trans_side'].nunique() > 1):
                    ...
                    cc = cc[~((cc['ViewData.Side0_UniqueIds'].isin(mtm_list_0_rv)) | (
                        cc['ViewData.Side1_UniqueIds'].isin(mtm_list_1_rv)))]
                    cc = cc.reset_index().drop('index', 1)
                    ...
                    cc['Forward_fx_flag'] = cc.apply(lambda x: forwardfx_tt_flag(x['ViewData.Transaction Type']),
                                                     axis=1)
                    ...
                    if cc[(cc['Forward_fx_flag'] == 1)].shape[0] > 0:
                        ...
                        dd2['filter_key_with_sd'] = dd2['filter_key'].astype(str) + dd2['ViewData.Settle Date'].astype(
                            str)
                    else:
                        dd2 = pd.DataFrame()
                    ...
                    if dd2.empty == False:
                        for key in dd2['filter_key_with_sd'].unique():
                            ...
                            # print(key)
                            if (-0.2 <= dd2_dummy['ViewData.Net Amount Difference'].sum() < 0.2) & (
                                    dd2_dummy.shape[0] > 2) & (dd2_dummy['Trans_side'].nunique() > 1):
                                # print(cc2_dummy.shape[0])
                                # print(key)
                    ...
                    if dd2.empty == False:
                        for key in filter_key_umt_umb_forward:
                            one_side_forward = dd2[dd2['filter_key_with_sd'] == key][
                                'ViewData.Side1_UniqueIds'].unique()
                            zero_side_forward = dd2[dd2['filter_key_with_sd'] == key][
                                'ViewData.Side0_UniqueIds'].unique()
                    ...
                    cc = cc[~((cc['ViewData.Side0_UniqueIds'].isin(mtm_list_0_fx)) | (
                        cc['ViewData.Side1_UniqueIds'].isin(mtm_list_1_fx)))]
                    cc = cc.reset_index().drop('index', 1)
                    ...
                    if cc[(cc['Expense_flag'] == 1)].shape[0] > 0:
                        ...
                        ee2['filter_key_with_sd'] = ee2['filter_key'].astype(str) + ee2['ViewData.Settle Date'].astype(
                            str)
                    else:
                        ee2 = pd.DataFrame()
                    ...
                    if ee2.empty == False:
                        for key in ee2['filter_key_with_sd'].unique():
                            ...
                            # print(key)
                            if (-0.2 <= ee2_dummy['ViewData.Net Amount Difference'].sum() < 0.2) & (
                                    ee2_dummy.shape[0] > 2) & (ee2_dummy['Trans_side'].nunique() > 1):
                                # print(cc2_dummy.shape[0])
                                # print(key)
                    ...
                    if ee2.empty == False:
                        for key in filter_key_umt_umb_expense:
                            one_side_expense = ee2[ee2['filter_key_with_sd'] == key][
                                'ViewData.Side1_UniqueIds'].unique()
                            zero_side_expense = ee2[ee2['filter_key_with_sd'] == key][
                                'ViewData.Side0_UniqueIds'].unique()
                    ...
                    cc = cc[~((cc['ViewData.Side0_UniqueIds'].isin(mtm_list_0_ex)) | (
                        cc['ViewData.Side1_UniqueIds'].isin(mtm_list_1_ex)))]
                    cc = cc.reset_index().drop('index', 1)


                    # End change made on 11-12-2020
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After catching mtm for revenue, expense and stock loan')
                    ...
                    cc['Transfer_flag'] = cc.apply(
                        lambda x: transfer_desc(x['ViewData.Transaction Type'], x['ViewData.Description']), axis=1)
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before catching mtm for equity swap')
                    ...
                    if cc[(cc['Equity_Swap_flag'] == 1) | (cc['Transfer_flag'] == 1)].shape[0] > 0:
                        ...
                        cc2['filter_key_with_sd'] = cc2['filter_key'].astype(str) + cc2['ViewData.Settle Date'].astype(
                            str)
                    else:
                        cc2 = pd.DataFrame()
                    ...
                    if cc2.empty == False:
                        for key in cc2['filter_key_with_sd'].unique():
                            ...
                            if (-1 <= cc2_dummy['ViewData.Net Amount Difference'].sum() <= 1) & (
                                    cc2_dummy.shape[0] > 2) & (cc2_dummy['Trans_side'].nunique() > 1):
                                # print(cc2_dummy.shape[0])
                                # print(key)
...
#                        return comment
                    ...
                    if diff_in_amount_df.empty == False:
                        ...
                        diff_in_amount_df['comment'] = diff_in_amount_df.apply(
                            lambda x: eq_swap_comment(x['filter_key_with_sd'], x['diff_in_amount']), axis=1)
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After catching mtm for equity swap')
                    ...
                    cc6 = cc[~((cc['ViewData.Side0_UniqueIds'].isin(mtm_list_0)) | (
                        cc['ViewData.Side1_UniqueIds'].isin(mtm_list_1)))]
                    ...
                    cc6 = cc6[~((cc6['ViewData.Side1_UniqueIds'].isin(comment_one_side)) | (
                        cc6['ViewData.Side0_UniqueIds'].isin(comment_zero_side)))]
                    ...
                    if (len(new_close_flat) != 0):
                        closed_final_df = cc6[
                            cc6['ViewData.Side0_UniqueIds'].isin(new_close_flat) | cc6['ViewData.Side1_UniqueIds'].isin(
                                new_close_flat)]
                    ...
                    cc7 = cc6[~(cc6['ViewData.Side0_UniqueIds'].isin(new_close_flat) | cc6[
                        'ViewData.Side1_UniqueIds'].isin(new_close_flat))]
                    ...
                    try:
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before catching updown')
                        ...
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='dffacc and dffpb created')
    
                        bplist = dffpb.groupby('ViewData.Task Business Date1')['ViewData.Cust Net Amount'].apply(
                            list).reset_index()
                        acclist = dffacc.groupby('ViewData.Task Business Date1')['ViewData.Accounting Net Amount'].apply(
                            list).reset_index()
    
                        updlist = pd.merge(bplist, acclist, on='ViewData.Task Business Date1', how='inner')
    
                        if (updlist.shape[0] != 0):
                            updlist['upd_amt'] = updlist.apply(
                                lambda x: [value for value in x['ViewData.Cust Net Amount'] if
                                           value in x['ViewData.Accounting Net Amount']], axis=1)
                        ...
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='updlist created')
                        ...
                        if (dffpb.shape[0] != 0):
                            ...
                            dffpb['upd_mark'] = dffpb.apply(lambda x: updmark(x['ViewData.Cust Net Amount'], x['upd_amt']),
                                                            axis=1)
                        ...
                        if (dffacc.shape[0] != 0):
                            ...
                            dffacc['upd_mark'] = dffacc.apply(
                                lambda x: updmark(x['ViewData.Accounting Net Amount'], x['upd_amt']), axis=1)
                        ...
                        def amountelim(row):
                            ...
                            if (row['SideA.ViewData.Mapped Custodian Account'] == row[
                        ...
                        if ((dff4.shape[0] != 0) & (dff5.shape[0] != 0)):
                            Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='if statement started when dff4 and dff5 are non empty')
                            ...
                            k = list(set(list(set(dff5['ViewData.Task Business Date1'])) + list(
                                set(dff4['ViewData.Task Business Date1']))))
                            k1 = k
                            ...
                            for d in tqdm(k1):
                                ...
                                Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='appended data created')
                            ...
                            df_213_1['map_match'] = vec_equals_fun(SideAMappedCustodianAccount_values,
                                                                   SideBMappedCustodianAccount_values)
                            ...
                            df_213_1['amt_match'] = vec_equals_fun(SideAAccountingNetAmount_values,
                                                                   SideBCustNetAmount_values)
                            ...
                            df_213_1[['map_match', 'amt_match', 'fund_match', 'curr_match', 'sd_match']] = df_213_1.apply(
                                lambda row: amountelim(row), axis=1, result_type="expand")
                            ...
                            if elim1.shape[0] != 0:
                                ...
                                start_time_apply_first = timeit.default_timer()
                                elim1['SideA.predicted comment'] = elim1.apply(
                                    lambda x: updownat(x['map_match'], x['curr_match'], x['sd_match'], x['fund_match']),
                                    axis=1)
                                stop_time_apply_first = timeit.default_timer()
                                print('Time for first apply = ', stop_time_apply_first - start_time_apply_first)
                                start_time_apply_second = timeit.default_timer()
                                elim1['SideB.predicted comment'] = elim1.apply(
                                    lambda x: updownat(x['map_match'], x['curr_match'], x['sd_match'], x['fund_match']),
                                    axis=1)
                                stop_time_apply_second = timeit.default_timer()
                                print('Time for second apply = ', stop_time_apply_second - start_time_apply_second)
                                elim_col = ['ViewData.Side0_UniqueIds', 'ViewData.Side1_UniqueIds', 'predicted category',
                                            'predicted comment', 'Predicted_action']
                                ...
                                updown_mapped_custodian_acct_side0_ids = elim[
                                    (elim['predicted comment'] == 'up/down at mapped custodian account') & (
                                        ~elim['Side0_UniqueIds'].isin(['None', 'nan', '']))]['Side0_UniqueIds']
                                updown_mapped_custodian_acct_side1_ids = elim[
                                    (elim['predicted comment'] == 'up/down at mapped custodian account') & (
                                        ~elim['Side1_UniqueIds'].isin(['None', 'nan', '']))]['Side1_UniqueIds']
                                updown_currency_side0_ids = elim[(elim['predicted comment'] == 'up/down at currency') & (
                                    ~elim['Side0_UniqueIds'].isin(['None', 'nan', '']))]['Side0_UniqueIds']
                                updown_currency_side1_ids = elim[(elim['predicted comment'] == 'up/down at currency') & (
                                    ~elim['Side1_UniqueIds'].isin(['None', 'nan', '']))]['Side1_UniqueIds']
    
                                if ((len(updown_currency_side1_ids) != 0) & (
                                        len(updown_mapped_custodian_acct_side1_ids) != 0)):
                                    list_of_side1_ids_to_remove_from_aa_new = updown_currency_side1_ids.to_list() + updown_mapped_custodian_acct_side1_ids.to_list()
                                elif ((len(updown_currency_side1_ids) == 0) & (
                                        len(updown_mapped_custodian_acct_side1_ids) != 0)):
                                ...
                                if (len(list_of_side1_ids_to_remove_from_aa_new) != 0):
                                    list_of_side1_ids_to_remove_from_aa_new_without_duplicates = list(
                                        set(list_of_side1_ids_to_remove_from_aa_new))
                                ...
                                if (len(list_of_side0_ids_to_remove_from_bb_new) != 0):
                                    list_of_side0_ids_to_remove_from_bb_new_without_duplicates = list(
                                        set(list_of_side0_ids_to_remove_from_bb_new))
                                ...
                                aa_new = aa_new[~aa_new['ViewData.Side1_UniqueIds'].isin(
                                    list_of_side1_ids_to_remove_from_aa_new_without_duplicates)]
                                bb_new = bb_new[~bb_new['ViewData.Side0_UniqueIds'].isin(
                                    list_of_side0_ids_to_remove_from_bb_new_without_duplicates)]
    
                                #        Remove ids containing 'up/down at mapped custodian account' and ids containing 'up/down at currency' from elim.
                                elim_except_mapped_custodian_acct_and_currency = elim[~elim['Side1_UniqueIds'].isin(
                                    list_of_side1_ids_to_remove_from_aa_new_without_duplicates)]
                                elim_except_mapped_custodian_acct_and_currency = \
                                elim_except_mapped_custodian_acct_and_currency[
                                    ~elim_except_mapped_custodian_acct_and_currency['Side0_UniqueIds'].isin(
                                        list_of_side0_ids_to_remove_from_bb_new_without_duplicates)]
                        ...
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After catching updown')
...
#                    filepaths_no_pair_id_no_data_warning = '//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/' + client + '/UAT_Run/X_Test_' + setup_code + '/WARNING_no_pair_ids_' + setup_code + str(date_i) + '.csv'
                    ...
                    no_pair_ids = []
                    # max_rows = 5
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before mXn')
                    ...
                    for d in tqdm(aa_new['Date'].unique()):
                        ...
                        for key in (
                        list(np.unique(np.array(list(aa1['filter_key'].values) + list(bb1['filter_key'].values))))):
                            ...
                            # no_pair_ids.append(aa1[(aa1['filter_key']== key) & (aa1['ViewData.Status'].isin(['OB','SDB']))]['ViewData.Side1_UniqueIds'].values[0])
                                ...
                                no_pair_ids.append([aa1[(aa1['filter_key'] == key) & (
                                    aa1['ViewData.Status'].isin(['OB', 'SDB', 'CNF', 'CMF']))][
                                                        'ViewData.Side1_UniqueIds'].values])
                                no_pair_ids.append([bb1[(bb1['filter_key'] == key) & (
                                    bb1['ViewData.Status'].isin(['OB', 'SDB', 'CNF', 'CMF']))][
                                                        'ViewData.Side0_UniqueIds'].values])
...
#                        filepaths_no_pair_id_no_data_warning = '//vitblrdevcons01/Raman  Strategy ML 2.0/All_Data/' + client + '/UAT_Run/X_Test_' + setup_code + '/WARNING_no_pair_ids_' + setup_code + str(date_i) + '.csv'
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After mXn')

                    if (len(training_df) != 0):
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before mXn training df')
                        test_file = pd.concat(training_df)
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After mXn training df')

                        m_after_test_file_made_for_first_time = memory_profiler.memory_usage()
                        mem_diff_m_after_test_file_made_for_first_time = m_after_test_file_made_for_first_time[0] - \
                                                                         m_after_m_cross_n[0]
                        ...
                        test_file['SideB.ViewData.BreakID_B_side'] = test_file['SideB.ViewData.BreakID_B_side'].astype(
                            'int64')
                        test_file['SideA.ViewData.BreakID_A_side'] = test_file['SideA.ViewData.BreakID_A_side'].astype(
                            'int64')

                        test_file['SideB.ViewData.CUSIP'] = \
                            test_file['SideB.ViewData.CUSIP'].str.split(".", expand=True)[0]
                        test_file['SideA.ViewData.CUSIP'] = \
                        test_file['SideA.ViewData.CUSIP'].str.split(".", expand=True)[0]
                        ...
                        test_file['Currency_match'] = vec_equals_fun(values_Currency_match_A_Side,
                                                                     values_Currency_match_B_Side)
                        test_file['Trade_Date_match'] = vec_equals_fun(values_Trade_Date_match_A_Side,
                                                                       values_Trade_Date_match_B_Side)
                        test_file['Settle_Date_match'] = vec_equals_fun(values_Settle_Date_match_A_Side,
                                                                        values_Settle_Date_match_B_Side)
                        ...
                        test_file['Amount_diff_1'] = test_file['SideA.ViewData.Accounting Net Amount'] - test_file[
                            'SideB.ViewData.B-P Net Amount']
                        test_file['Amount_diff_2'] = test_file['SideB.ViewData.Accounting Net Amount'] - test_file[
                        ...
                        test_file['new_pb'] = test_file['SideA.ViewData.Mapped Custodian Account'].apply(
                            lambda x: x.split('_')[0] if type(x) == str else x)
                        ...
                        test_file['SideA.ViewData.Prime Broker'] = test_file['SideA.ViewData.Prime Broker'].fillna(
                            'kkk')

                        test_file['new_pb1'] = test_file.apply(
                            lambda x: x['new_pb'] if x['SideA.ViewData.Prime Broker'] == 'kkk' else x[
                                'SideA.ViewData.Prime Broker'], axis=1)
                        ...
                        test_file['Trade_date_diff'] = (
                                    pd.to_datetime(test_file['SideA.ViewData.Trade Date']) - pd.to_datetime(
                                test_file['SideB.ViewData.Trade Date'])).dt.days

                        test_file['Settle_date_diff'] = (
                                pd.to_datetime(test_file['SideA.ViewData.Settle Date']) - pd.to_datetime(
                            test_file['SideB.ViewData.Settle Date'])).dt.days
                        ...
                        remove_nums_A_side = [[item for item in sublist if not is_num(item)] for sublist in
                                              split_trans_A_side]
                        remove_nums_B_side = [[item for item in sublist if not is_num(item)] for sublist in
                                              split_trans_B_side]
                        ...
                        remove_dates_A_side = [
                            [item for item in sublist if not (is_date_format(item) or date_edge_cases(item))] for
                            sublist in remove_nums_A_side]
                        remove_dates_B_side = [
                            [item for item in sublist if not (is_date_format(item) or date_edge_cases(item))] for
                            sublist in remove_nums_B_side]

                        # Specific to clients already used on, will have to be edited for other edge cases
                        remove_amts_A_side = [[item for item in sublist if item[0] != '$'] for sublist in
                                              remove_dates_A_side]
                        remove_amts_B_side = [[item for item in sublist if item[0] != '$'] for sublist in
                                              remove_dates_B_side]
                        ...
                        remove_ons_A_side = [(item[:item.index('on')] if 'on' in item else item) for item in
                                             clean_tax_A_side]
                        remove_ons_B_side = [(item[:item.index('on')] if 'on' in item else item) for item in
                                             clean_tax_B_side]
                        ...
                        remove_mh_A_side = [[item for item in sublist if 'mh' not in item] for sublist in
                                            clean_eqswap_A_side]
                        remove_mh_B_side = [[item for item in sublist if 'mh' not in item] for sublist in
                                            clean_eqswap_B_side]

                        remove_ats_A_side = [(item[:item.index('@')] if '@' in item else item) for item in
                                             remove_mh_A_side]
                        remove_ats_B_side = [(item[:item.index('@')] if '@' in item else item) for item in
                                             remove_mh_B_side]
                        ...
                        remove_nums_i_A_side = [[item for item in sublist if not is_num(item)] for sublist in
                                                split_invest_A_side]
                        remove_nums_i_B_side = [[item for item in sublist if not is_num(item)] for sublist in
                                                split_invest_B_side]

                        remove_dates_i_A_side = [[item for item in sublist if not is_date_format(item)] for sublist in
                                                 remove_nums_i_A_side]
                        remove_dates_i_B_side = [[item for item in sublist if not is_date_format(item)] for sublist in
                                                 remove_nums_i_B_side]
                        ...
                        remove_nums_a_A_side = [[item for item in sublist if not is_num(item)] for sublist in
                                                split_asset_A_side]
                        remove_nums_a_B_side = [[item for item in sublist if not is_num(item)] for sublist in
                                                split_asset_B_side]

                        remove_dates_a_A_side = [[item for item in sublist if not is_date_format(item)] for sublist in
                                                 remove_nums_a_A_side]
                        remove_dates_a_B_side = [[item for item in sublist if not is_date_format(item)] for sublist in
                                                 remove_nums_a_B_side]
                        ...
                        # test_file['ISIN_match'] = vec_(values_ISIN_A_Side,values_ISIN_B_Side)
                        # test_file['SideA.ViewData.Fund'] = test_file.apply(lambda x : fundmatch(x['SideA.ViewData.Fund']), axis=1)
                        test_file['SideA.ViewData.Transaction Type'] = vec_tt_match(
                            values_transaction_type_match_A_Side)
                        # test_file['SideB.ViewData.Fund'] = test_file.apply(lambda x : fundmatch(x['SideB.ViewData.Fund']), axis=1)
                        test_file['SideB.ViewData.Transaction Type'] = vec_tt_match(
                            values_transaction_type_match_B_Side)

                        test_file.loc[test_file[
                                          'SideA.ViewData.Transaction Type'] == 'int', 'SideA.ViewData.Transaction Type'] = 'interest'
                        test_file.loc[test_file[
                                          'SideA.ViewData.Transaction Type'] == 'wires', 'SideA.ViewData.Transaction Type'] = 'wire'
                        test_file.loc[test_file[
                                          'SideA.ViewData.Transaction Type'] == 'dividends', 'SideA.ViewData.Transaction Type'] = 'dividend'
                        test_file.loc[test_file[
                                          'SideA.ViewData.Transaction Type'] == 'miscellaneous', 'SideA.ViewData.Transaction Type'] = 'misc'
                        test_file.loc[test_file[
                                          'SideA.ViewData.Transaction Type'] == 'div', 'SideA.ViewData.Transaction Type'] = 'dividend'

                        test_file['SideA.ViewData.Investment Type'] = test_file['SideA.ViewData.Investment Type'].apply(
                            lambda x: x.replace('eqty', 'equity'))
                        test_file['SideA.ViewData.Investment Type'] = test_file['SideA.ViewData.Investment Type'].apply(
                            lambda x: x.replace('options', 'option'))
                        test_file['SideA.ViewData.Investment Type'] = test_file['SideA.ViewData.Investment Type'].apply(
                            lambda x: x.replace('eqt', 'equity'))
                        test_file['SideA.ViewData.Investment Type'] = test_file['SideA.ViewData.Investment Type'].apply(
                            lambda x: x.replace('eqty', 'equity'))

                        test_file['SideB.ViewData.Investment Type'] = test_file['SideB.ViewData.Investment Type'].apply(
                            lambda x: x.replace('eqty', 'equity'))
                        test_file['SideB.ViewData.Investment Type'] = test_file['SideB.ViewData.Investment Type'].apply(
                            lambda x: x.replace('options', 'option'))
                        test_file['SideB.ViewData.Investment Type'] = test_file['SideB.ViewData.Investment Type'].apply(
                        ...
                        test_file['ViewData.Combined Transaction Type'] = test_file[
                                                                              'SideA.ViewData.Transaction Type'].astype(
                            str) + test_file['SideB.ViewData.Transaction Type'].astype(str)
                        ...
                        test_file['ViewData.Combined Fund'] = test_file['SideA.ViewData.Fund'].astype(str) + test_file[
                            'SideB.ViewData.Fund'].astype(str)

                        test_file['Combined_Investment_Type'] = test_file['SideA.ViewData.Investment Type'].astype(
                            str) + test_file['SideB.ViewData.Investment Type'].astype(str)

                        test_file['Combined_Asset_Type_Category'] = test_file[
                                                                        'SideA.ViewData.Asset Category Type'].astype(
                            str) + test_file['SideB.ViewData.Asset Category Type'].astype(str)
                        ...
                        test_file['SideB.ViewData.key_NAN'] = \
                        vec_a_key_match_fun(values_CUSIP_B_Side, values_ISIN_B_Side)[0]
                        test_file['SideB.ViewData.Common_key'] = \
                        vec_a_key_match_fun(values_CUSIP_B_Side, values_ISIN_B_Side)[1]
                        test_file['SideA.ViewData.key_NAN'] = \
                        vec_b_key_match_fun(values_CUSIP_A_Side, values_ISIN_A_Side)[0]
                        test_file['SideA.ViewData.Common_key'] = \
                        vec_b_key_match_fun(values_CUSIP_A_Side, values_ISIN_A_Side)[1]
                        ...
                        test_file['new_key_match'] = vec_new_key_match_fun(values_Common_key_B_Side,
                                                                           values_Common_key_A_Side, values_All_key_NAN)

                        test_file['amount_percent'] = (test_file['SideA.ViewData.B-P Net Amount'] / test_file[
                            'SideB.ViewData.Accounting Net Amount'] * 100)
                        ...
                        test_file['SideB.ViewData.Prime Broker'] = test_file['SideB.ViewData.Prime Broker'].apply(
                            lambda x: str(x).lower())
                        test_file['SideA.ViewData.Prime Broker'] = test_file['SideA.ViewData.Prime Broker'].apply(
                            lambda x: str(x).lower())

                        test_file['SideB.ViewData.Asset Type Category'] = test_file[
                            'SideB.ViewData.Asset Type Category'].apply(lambda x: str(x).lower())
                        test_file['SideA.ViewData.Asset Type Category'] = test_file[
                            'SideA.ViewData.Asset Type Category'].apply(lambda x: str(x).lower())
                        ...
                        test_file = clean_text(test_file, 'SideA.ViewData.Description',
                                               'SideA.ViewData.Description_new')
                        test_file = clean_text(test_file, 'SideB.ViewData.Description',
                                               'SideB.ViewData.Description_new')
                        ...
                        # test_file['ISIN_match'] = vec_(values_ISIN_A_Side,values_ISIN_B_Side)
                        # test_file['SideA.ViewData.Fund'] = test_file.apply(lambda x : fundmatch(x['SideA.ViewData.Fund']), axis=1)
                        test_file['description_similarity_score'] = vec_desc_simi(values_desc_new_A_Side,
                                                                                  values_desc_new_B_Side)
                        ...
                        # le = LabelEncoder()
                        for feature in ['SideA.Date', 'SideB.Date', 'SideA.ViewData.Settle Date',
                                        'SideB.ViewData.Settle Date', 'SideA.ViewData.Trade Date',
                        ...
                        mem_diff_m_after_test_file_all_cleaning = m_after_test_file_all_cleaning[0] - \
                                                                  m_after_test_file_made_for_first_time[0]
                        ...
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After test file cleaning')
                        ...
                        model_cols = ['SideA.ViewData.B-P Net Amount',
                                      ...
                                      'All_key_nan', 'new_key_match', 'new_pb1', 'desc_any_match', 'SEDOL_match',
                                      'TD_bucket', 'SD_bucket',
                                      # 'Combined_TType',
                                      # 'SideB.Date',
                                      'SideA.ViewData._ID', 'SideB.ViewData._ID', 'SideB.ViewData.Side0_UniqueIds',
                        ...
                        test_file['tt_map_flag'] = np.where(
                            test_file['ViewData.Combined Transaction Type'].isin(Weiss_umr_list), 1, 0)
                        ...
                        def sedol_match(text1, text2):
                            if text1 not in ['nan', 'None', ''] and text2 not in ['nan', 'None', ''] and (
                                    text1 in text2 or text2 in text1):
                                return 1
                            elif text1 not in ['nan', 'None', ''] and text2 not in ['nan', 'None', ''] and (
                                    text1 not in text2 or text2 not in text1):
                                return 2
                            else:
                                return 0
                        ...
                        test_file['desc_any_match'] = vec_desc_any_string_check(values_desc_new_A_Side,
                                                                                values_desc_new_B_Side)
                        ...
                        test_file['SideB.ViewData.Transaction Type'] = test_file[
                            'SideB.ViewData.Transaction Type'].apply(lambda x: mhreplaced(x))
                        test_file['SideA.ViewData.Transaction Type'] = test_file[
                            'SideA.ViewData.Transaction Type'].apply(lambda x: mhreplaced(x))

                        test_file['SideA.ViewData.Transaction Type'] = test_file[
                            'SideA.ViewData.Transaction Type'].apply(lambda x: x.lower())
                        test_file['SideA.ViewData.Transaction Type'] = test_file[
                            'SideA.ViewData.Transaction Type'].apply(lambda x: inttype(x))
                        test_file['SideA.ViewData.Transaction Type'] = test_file[
                            'SideA.ViewData.Transaction Type'].apply(lambda x: divclient(x))
                        test_file['SideA.ViewData.Transaction Type'] = test_file[
                            'SideA.ViewData.Transaction Type'].apply(lambda x: mhreplace(x))
                        test_file['SideA.ViewData.Transaction Type'] = test_file[
                            'SideA.ViewData.Transaction Type'].apply(lambda x: dollarreplace(x))
                        test_file['SideA.ViewData.Transaction Type'] = test_file[
                            'SideA.ViewData.Transaction Type'].apply(lambda x: thirtyper(x))

                        test_file['SideB.ViewData.Transaction Type'] = test_file[
                            'SideB.ViewData.Transaction Type'].apply(lambda x: x.lower())
                        test_file['SideB.ViewData.Transaction Type'] = test_file[
                            'SideB.ViewData.Transaction Type'].apply(lambda x: inttype(x))
                        test_file['SideB.ViewData.Transaction Type'] = test_file[
                            'SideB.ViewData.Transaction Type'].apply(lambda x: divclient(x))
                        test_file['SideB.ViewData.Transaction Type'] = test_file[
                            'SideB.ViewData.Transaction Type'].apply(lambda x: mhreplace(x))
                        test_file['SideB.ViewData.Transaction Type'] = test_file[
                            'SideB.ViewData.Transaction Type'].apply(lambda x: dollarreplace(x))
                        test_file['SideB.ViewData.Transaction Type'] = test_file[
                            'SideB.ViewData.Transaction Type'].apply(lambda x: thirtyper(x))

                        test_file['SideA.ViewData.Transaction Type'] = test_file[
                            'SideA.ViewData.Transaction Type'].apply(lambda x: x.replace('withdrawal', 'withdraw'))
                        test_file['SideA.ViewData.Transaction Type'] = test_file[
                            'SideA.ViewData.Transaction Type'].apply(lambda x: x.replace('cover short', 'covershort'))

                        test_file['ViewData.Combined Transaction Type'] = test_file[
                                                                              'SideA.ViewData.Transaction Type'].astype(
                            str) + test_file['SideB.ViewData.Transaction Type'].astype(str)
                        test_file['ViewData.Combined Transaction Type'] = test_file[
                            'ViewData.Combined Transaction Type'].apply(lambda x: x.replace('jnl', 'journal'))
                        ...
                        test_file['SideA.ViewData.Trade Date'] = test_file['SideA.ViewData.Trade Date'].astype(
                            float).astype(int)

                        test_file['TD_bucket'] = test_file['Trade_date_diff'].apply(
                            lambda x: 0 if x == 0 else (1 if x >= -2 and x <= 2 else 2))
                        test_file['SD_bucket'] = test_file['Settle_date_diff'].apply(
                            lambda x: 0 if x == 0 else (1 if x >= -2 and x <= 2 else 2))
                        ...
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After test file 3')

                        test_file3 = test_file[~(
                                    test_file['SideA.ViewData.Side1_UniqueIds'].isin(new_closed_keys) | test_file[
                                'SideB.ViewData.Side0_UniqueIds'].isin(new_closed_keys))]
                        ...
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before Xtest creation')
                        ...
                        rf_predictions = clf.predict(X_test.drop(
                            ['SideB.ViewData.Status', 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.Status',
                             'SideA.ViewData.BreakID_A_side', 'SideA.ViewData._ID', 'SideB.ViewData._ID',
                             'SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds'], 1))
                        # Probabilities for each class
                        rf_probs = clf.predict_proba(X_test.drop(
                            ['SideB.ViewData.Status', 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.Status',
                             'SideA.ViewData.BreakID_A_side', 'SideA.ViewData._ID', 'SideB.ViewData._ID',
                             'SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds'], 1))[:, 1]

                        probability_class_0 = clf.predict_proba(X_test.drop(
                            ['SideB.ViewData.Status', 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.Status',
                             'SideA.ViewData.BreakID_A_side', 'SideA.ViewData._ID', 'SideB.ViewData._ID',
                             'SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds'], 1))[:, 0]
                        probability_class_1 = clf.predict_proba(X_test.drop(
                            ['SideB.ViewData.Status', 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.Status',
                             'SideA.ViewData.BreakID_A_side', 'SideA.ViewData._ID', 'SideB.ViewData._ID',
                             'SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds'], 1))[:, 1]

                        probability_class_2 = clf.predict_proba(X_test.drop(
                            ['SideB.ViewData.Status', 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.Status',
                             'SideA.ViewData.BreakID_A_side', 'SideA.ViewData._ID', 'SideB.ViewData._ID',
                             'SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds'], 1))[:, 2]
                        probability_class_3 = clf.predict_proba(X_test.drop(
                            ['SideB.ViewData.Status', 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.Status',
                             'SideA.ViewData.BreakID_A_side', 'SideA.ViewData._ID', 'SideB.ViewData._ID',
                             'SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds'], 1))[:, 3]
                        ...
                        model_cols_2 = [
                            ...
                            'SideB.Date', 'SideA.ViewData.Settle Date', 'SideB.ViewData.Settle Date',
                            'SideA.ViewData.Trade Date', 'SideB.ViewData.Trade Date',
                            'All_key_nan', 'new_key_match', 'new_pb1', 'desc_any_match', 'SEDOL_match', 'TD_bucket',
                            'SD_bucket',
                            # 'Combined_TType',
                            # 'SideB.Date',
                            'SideA.ViewData._ID', 'SideB.ViewData._ID', 'SideB.ViewData.Side0_UniqueIds',
                        ...
                        mem_diff_m_after_X_test_first_prediction = m_after_X_test_first_prediction[0] - m_before_X_test[
                            0]
                        print(f"It took {mem_diff_m_after_X_test_first_prediction} Mb to execute this method")
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After Xtest first prediction')
                       ...
                       # It took 916.24609375 Mb to execute this method
                        ...
                        # Actual class predictions
                        rf_predictions2 = clf2.predict(X_test2.drop(
                            ['SideB.ViewData.Status', 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.Status',
                             'SideA.ViewData.BreakID_A_side', 'SideA.ViewData._ID', 'SideB.ViewData._ID',
                             'SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds'], 1))
                        # Probabilities for each class
                        rf_probs2 = clf2.predict_proba(X_test2.drop(
                            ['SideB.ViewData.Status', 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.Status',
                             'SideA.ViewData.BreakID_A_side', 'SideA.ViewData._ID', 'SideB.ViewData._ID',
                             'SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds'], 1))[:, 1]

                        probability_class_0_two = clf2.predict_proba(X_test2.drop(
                            ['SideB.ViewData.Status', 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.Status',
                             'SideA.ViewData.BreakID_A_side', 'SideA.ViewData._ID', 'SideB.ViewData._ID',
                             'SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds'], 1))[:, 0]
                        probability_class_1_two = clf2.predict_proba(X_test2.drop(
                            ['SideB.ViewData.Status', 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.Status',
                             'SideA.ViewData.BreakID_A_side', 'SideA.ViewData._ID', 'SideB.ViewData._ID',
                             'SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds'], 1))[:, 1]
                        ...
                        mem_diff_m_after_X_test_second_prediction = m_after_X_test_second_prediction[0] - \
                                                                    m_after_X_test_first_prediction[0]
                        print(f"It took {mem_diff_m_after_X_test_second_prediction} Mb to execute this method")
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After Xtest second prediction')

                        # It took 115.390625 Mb to execute this method
                        X_test = pd.concat(
                            [X_test, X_test2[['Predicted_action_2', 'probability_No_pair_2', 'probability_UMB_2']]],
                            axis=1)

                        X_test.loc[(X_test['Amount_diff_2'] != 0) & (X_test[
                                                                         'Predicted_action'] == 'UMR_One_to_One'), 'Predicted_action'] = 'UMB_One_to_One'

                        X_test.loc[(X_test['Amount_diff_2'] == 0) & (X_test[
                                                                         'Predicted_action'] == 'UMB_One_to_One'), 'Predicted_action'] = 'UMR_One_to_One'

                        X_test.loc[((X_test['Amount_diff_2'] > 1) | (X_test['Amount_diff_2'] < -1)) & (X_test[
...
#                        filepaths_X_test = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\X_Test_for_Pratik_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        abs_amount_table = X_test.groupby(['SideB.ViewData.Side0_UniqueIds'])[
                            'abs_amount_flag'].max().reset_index()
                        abs_amount_table[abs_amount_table['abs_amount_flag'] == 1]['SideB.ViewData.Side0_UniqueIds']

                        duplicate_entries = abs_amount_table[abs_amount_table['abs_amount_flag'] == 1][
                            'SideB.ViewData.Side0_UniqueIds'].unique()
                        ...
                        if len(duplicate_entries) > 0:
                            ...
                            for id_0 in duplicate_entries:
                                dup_id_1_array = dup_df[(dup_df['SideB.ViewData.Side0_UniqueIds'] == id_0) & (
                                        (dup_df['Predicted_action'] == 'UMR_One_to_One') | (
                                                dup_df['abs_amount_flag'] == 1))][
                                    'SideA.ViewData.Side1_UniqueIds'].values
                        ...
                        if (dup_otm_table_new.shape[0] != 0):
                            ...
                            dup_otm_table_new_raw['otm_or_oto_comma_position'] = dup_otm_table_new_raw[
                                'SideA.ViewData.Side1_UniqueIds'].apply(
                                lambda x: str(x).replace("' '", "' , '").find(','))
                            dup_otm_table_new_raw['otm_or_oto_flag'] = dup_otm_table_new_raw[
                                'otm_or_oto_comma_position'].apply(lambda x: 'oto' if x == -1 else 'otm')
                            dup_otm_table_new_final = \
...
#                            filepaths_dup_otm_table_new_final = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\dup_otm_table_new_final_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        X_test['Tolerance_level'] = np.abs(
                            X_test['probability_UMB_2'] - X_test['probability_No_pair_2'])

                        # X_test[X_test['Tolerance_level']<0.1]['Predicted_action'].value_counts()

                        b_side_agg = X_test.groupby(['SideB.ViewData.Side0_UniqueIds'])[
                            'Predicted_action_2'].unique().reset_index()
                        a_side_agg = X_test.groupby(['SideA.ViewData.Side1_UniqueIds'])[
                            'Predicted_action_2'].unique().reset_index()
                        ...
                        def umr_seg(X_test):
                            b_count = X_test.groupby(['SideB.ViewData.Side0_UniqueIds'])[
                                'Predicted_action'].value_counts().reset_index(name='count')
                            b_unique = X_test.groupby(['SideB.ViewData.Side0_UniqueIds'])[
                                'Predicted_action'].unique().reset_index()

                            b_unique['len'] = b_unique['Predicted_action'].str.len()
                            b_count2 = pd.merge(b_count, b_unique.drop('Predicted_action', 1),
                                                on='SideB.ViewData.Side0_UniqueIds', how='left')
                            umr_table = b_count2[
                                (b_count2['Predicted_action'] == 'UMR_One_to_One') & (b_count2['count'] <= 3) & (
                                            b_count2['len'] <= 3)]
                        ...
                        def umt_seg(X_test):
                            ...
                            b_count2 = pd.merge(b_count, b_unique.drop('Predicted_action', 1),
                                                on='SideB.ViewData.Side0_UniqueIds', how='left')
                            umt_table = b_count2[
                                (b_count2['Predicted_action'] == 'UMT_One_to_One') & (b_count2['count'] == 1) & (
                                            b_count2['len'] <= 3)]
                        ...
                        X_test[X_test['SideB.ViewData.Side0_UniqueIds'].isin(umt_seg(X_test)) & (
                                    X_test['Predicted_action'] == 'UMT_One_to_One')].shape

                        umr_ids_0 = umr_seg(X_test)
                        umt_ids_0 = umt_seg(X_test)

                        m_after_X_test_umt_seg = memory_profiler.memory_usage()
                        mem_diff_m_after_X_test_umt_seg = m_after_X_test_umt_seg[0] - m_after_X_test_second_prediction[
                            0]
                        print(f"It took {mem_diff_m_after_X_test_umt_seg} Mb to execute this method")
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After Xtest UMT segregation')

                        # It took 64.3515625 Mb to execute this method

                        # ## 1st Prediction Table for One to One UMR

                        final_umr_table = X_test[X_test['SideB.ViewData.Side0_UniqueIds'].isin(umr_ids_0) & (
                                X_test['Predicted_action'] == 'UMR_One_to_One')]

                        final_umr_table_Side0_count_ge_1 = final_umr_table[
                            'SideB.ViewData.Side0_UniqueIds'].value_counts().reset_index()
                        final_umr_table_Side1_count_ge_1 = final_umr_table[
                            'SideA.ViewData.Side1_UniqueIds'].value_counts().reset_index()

                        duplicate_ids_final_umr_table_Side0 = final_umr_table_Side0_count_ge_1[
                            final_umr_table_Side0_count_ge_1['SideB.ViewData.Side0_UniqueIds'] > 1]['index'].unique()
                        duplicate_ids_final_umr_table_Side1 = final_umr_table_Side1_count_ge_1[
                            final_umr_table_Side1_count_ge_1['SideA.ViewData.Side1_UniqueIds'] > 1]['index'].unique()

                        if (len(duplicate_ids_final_umr_table_Side0) != 0):
                            final_umr_table_duplicates_Side0 = final_umr_table[
                                final_umr_table['SideB.ViewData.Side0_UniqueIds'].isin(
                                    duplicate_ids_final_umr_table_Side0)]
                            final_umr_table_duplicates_Side0 = final_umr_table_duplicates_Side0[
                                ['SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds',
                                 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.BreakID_A_side', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'probability_UMT']]
                            final_umr_table = final_umr_table[~final_umr_table['SideB.ViewData.Side0_UniqueIds'].isin(
                                duplicate_ids_final_umr_table_Side0)]
                            final_umr_table_side0_ids = list(set(final_umr_table['SideB.ViewData.Side0_UniqueIds']))
                            side0_umr_ids_to_remove_from_final_open_table = final_umr_table_side0_ids + list(
                                duplicate_ids_final_umr_table_Side0)
                        ...
                        if (len(duplicate_ids_final_umr_table_Side1) != 0):
                            final_umr_table_duplicates_Side1 = final_umr_table[
                                final_umr_table['SideA.ViewData.Side1_UniqueIds'].isin(
                                    duplicate_ids_final_umr_table_Side1)]
                            final_umr_table_duplicates_Side1 = final_umr_table_duplicates_Side1[
                                ['SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds',
                                 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.BreakID_A_side', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'probability_UMT']]
                            final_umr_table = final_umr_table[~final_umr_table['SideA.ViewData.Side1_UniqueIds'].isin(
                                duplicate_ids_final_umr_table_Side1)]
                            final_umr_table_side1_ids = list(set(final_umr_table['SideA.ViewData.Side1_UniqueIds']))
                            side1_umr_ids_to_remove_from_final_open_table = final_umr_table_side1_ids + list(
                                duplicate_ids_final_umr_table_Side1)
                        ...
                        final_umr_table = final_umr_table[
                            ['SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds',
                             'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.BreakID_A_side', 'Predicted_action',
                             'probability_No_pair', 'probability_UMB', 'probability_UMR', 'probability_UMT']]
                        ...
                        if (flag_side0_ids_to_remove_from_bb_new_exist == 1):
                            side0_intersection_elim_umr = set(
                                elim_except_mapped_custodian_acct_and_currency['Side0_UniqueIds']) & set(
                                final_umr_table['SideB.ViewData.Side0_UniqueIds'])
                            elim_except_mapped_custodian_acct_and_currency_and_umr = \
                            elim_except_mapped_custodian_acct_and_currency[
                                ~elim_except_mapped_custodian_acct_and_currency['Side0_UniqueIds'].isin(
                                    list(side0_intersection_elim_umr))]
                        ...
                        if (flag_side1_ids_to_remove_from_aa_new_exist == 1):
                            side1_intersection_elim_umr = set(
                                elim_except_mapped_custodian_acct_and_currency['Side1_UniqueIds']) & set(
                                final_umr_table['SideA.ViewData.Side1_UniqueIds'])
                            elim_except_mapped_custodian_acct_and_currency_and_umr = \
                                elim_except_mapped_custodian_acct_and_currency_and_umr[
                                    ~elim_except_mapped_custodian_acct_and_currency_and_umr['Side1_UniqueIds'].isin(
                                    list(side1_intersection_elim_umr))]
                        ...
                        final_umt_table = X_test[X_test['SideB.ViewData.Side0_UniqueIds'].isin(umt_ids_0) & (
                                    X_test['Predicted_action'] == 'UMT_One_to_One')]

                        final_umt_table_Side0_count_ge_1 = final_umt_table[
                            'SideB.ViewData.Side0_UniqueIds'].value_counts().reset_index()
                        final_umt_table_Side1_count_ge_1 = final_umt_table[
                            'SideA.ViewData.Side1_UniqueIds'].value_counts().reset_index()

                        duplicate_ids_final_umt_table_Side0 = final_umt_table_Side0_count_ge_1[
                            final_umt_table_Side0_count_ge_1['SideB.ViewData.Side0_UniqueIds'] > 1]['index'].unique()
                        duplicate_ids_final_umt_table_Side1 = final_umt_table_Side1_count_ge_1[
                            final_umt_table_Side1_count_ge_1['SideA.ViewData.Side1_UniqueIds'] > 1]['index'].unique()

                        if (len(duplicate_ids_final_umt_table_Side0) != 0):
                            final_umt_table_duplicates_Side0 = final_umt_table[
                                final_umt_table['SideB.ViewData.Side0_UniqueIds'].isin(
                                    duplicate_ids_final_umt_table_Side0)]
                            final_umt_table_duplicates_Side0 = final_umt_table_duplicates_Side0[
                                ['SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds',
                                 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.BreakID_A_side', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'probability_UMT']]
                            final_umt_table = final_umt_table[~final_umt_table['SideB.ViewData.Side0_UniqueIds'].isin(
                                duplicate_ids_final_umt_table_Side0)]
                            final_umt_table_side0_ids = list(set(final_umt_table['SideB.ViewData.Side0_UniqueIds']))
                            side0_umt_ids_to_remove_from_final_open_table = final_umt_table_side0_ids + list(
                                duplicate_ids_final_umt_table_Side0)
                        ...
                        if (len(duplicate_ids_final_umt_table_Side1) != 0):
                            final_umt_table_duplicates_Side1 = final_umt_table[
                                final_umt_table['SideA.ViewData.Side1_UniqueIds'].isin(
                                    duplicate_ids_final_umt_table_Side1)]
                            final_umt_table_duplicates_Side1 = final_umt_table_duplicates_Side1[
                                ['SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds',
                                 'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.BreakID_A_side', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'probability_UMT']]
                            final_umt_table = final_umt_table[~final_umt_table['SideA.ViewData.Side1_UniqueIds'].isin(
                                duplicate_ids_final_umt_table_Side1)]
                            final_umt_table_side1_ids = list(set(final_umt_table['SideA.ViewData.Side1_UniqueIds']))
                            side1_umt_ids_to_remove_from_final_open_table = final_umt_table_side1_ids + list(
                                duplicate_ids_final_umt_table_Side1)
                        ...
                        final_umt_table = final_umt_table[
                            ['SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds',
                             'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.BreakID_A_side', 'Predicted_action',
                             'probability_No_pair', 'probability_UMB', 'probability_UMR', 'probability_UMT']]

                        m_before_X_test_no_pair_seg = memory_profiler.memory_usage()
                        mem_diff_m_before_X_test_no_pair_seg = m_before_X_test_no_pair_seg[0] - m_after_X_test_umt_seg[
                            0]
                        print(f"It took {mem_diff_m_before_X_test_no_pair_seg} Mb to execute this method")
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before Xtest no pair segregation')
                        ...
                        def no_pair_seg(X_test):
                            ...
                            b_side_agg['No_Pair_flag'] = b_side_agg['Predicted_action_2'].apply(
                                lambda x: 1 if 'No-Pair' in x else 0)

                            a_side_agg['len'] = a_side_agg['Predicted_action_2'].str.len()
                            a_side_agg['No_Pair_flag'] = a_side_agg['Predicted_action_2'].apply(
                                lambda x: 1 if 'No-Pair' in x else 0)

                            no_pair_ids_b_side = \
                            b_side_agg[(b_side_agg['len'] == 1) & (b_side_agg['No_Pair_flag'] == 1)][
                                'SideB.ViewData.Side0_UniqueIds'].values

                            no_pair_ids_a_side = \
                            a_side_agg[(a_side_agg['len'] == 1) & (a_side_agg['No_Pair_flag'] == 1)][
                                'SideA.ViewData.Side1_UniqueIds'].values
                        ...
                        final_open_table = X_test[
                            (X_test['SideB.ViewData.Side0_UniqueIds'].isin(no_pair_ids_b_side)) | (
                                X_test['SideA.ViewData.Side1_UniqueIds'].isin(no_pair_ids_a_side))]

                        final_open_table = final_open_table[~final_open_table['SideA.ViewData.Side1_UniqueIds'].isin(
                            side1_umr_ids_to_remove_from_final_open_table)]
                        final_open_table = final_open_table[~final_open_table['SideB.ViewData.Side0_UniqueIds'].isin(
                            side0_umr_ids_to_remove_from_final_open_table)]
                        final_open_table = final_open_table[~final_open_table['SideA.ViewData.Side1_UniqueIds'].isin(
                            side1_umt_ids_to_remove_from_final_open_table)]
                        final_open_table = final_open_table[~final_open_table['SideB.ViewData.Side0_UniqueIds'].isin(
                            side0_umt_ids_to_remove_from_final_open_table)]

                        final_open_table = final_open_table[
                            ['SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds',
                             'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.BreakID_A_side', 'Predicted_action_2',
                             'probability_No_pair_2', 'probability_UMB_2', 'probability_UMR']]

                        final_open_table['probability_UMR'] = 0.00010
                        final_open_table = final_open_table.rename(columns={'Predicted_action_2': 'Predicted_action',
                                                                            'probability_No_pair_2': 'probability_No_pair',
                                                                            'probability_UMB_2': 'probability_UMB'})

                        b_side_open_table = final_open_table.groupby('SideB.ViewData.Side0_UniqueIds')[
                            ['probability_No_pair', 'probability_UMB', 'probability_UMR']].mean().reset_index()
                        a_side_open_table = final_open_table.groupby('SideA.ViewData.Side1_UniqueIds')[
                            ['probability_No_pair', 'probability_UMB', 'probability_UMR']].mean().reset_index()

                        a_side_open_table = a_side_open_table[
                            a_side_open_table['SideA.ViewData.Side1_UniqueIds'].isin(no_pair_ids_a_side)]
                        b_side_open_table = b_side_open_table[
                            b_side_open_table['SideB.ViewData.Side0_UniqueIds'].isin(no_pair_ids_b_side)]
                        ...
                        final_no_pair_table = pd.merge(final_no_pair_table, final_open_table[
                            ['SideA.ViewData.Side1_UniqueIds', 'SideA.ViewData.BreakID_A_side']].drop_duplicates(),
                                                       on='SideA.ViewData.Side1_UniqueIds', how='left')
                        final_no_pair_table = pd.merge(final_no_pair_table, final_open_table[
                            ['SideB.ViewData.Side0_UniqueIds', 'SideB.ViewData.BreakID_B_side']].drop_duplicates(),
                                                       on='SideB.ViewData.Side0_UniqueIds', how='left')

                        # Rohit FINAL_NO_PAIR_TABLE table

                        final_no_pair_table = normalize_final_no_pair_table_col_names(
                            fun_final_no_pair_table=final_no_pair_table)
                        final_no_pair_table_copy = final_no_pair_table.copy()
                        #
                        final_no_pair_table_copy['ViewData.Side0_UniqueIds'] = final_no_pair_table_copy[
                            'ViewData.Side0_UniqueIds'].astype(str)
                        final_no_pair_table_copy['ViewData.Side1_UniqueIds'] = final_no_pair_table_copy[
                            'ViewData.Side1_UniqueIds'].astype(str)

                        final_no_pair_table_copy.loc[
                            final_no_pair_table_copy['ViewData.Side0_UniqueIds'] == 'None', 'Side0_1_UniqueIds'] = \
                        final_no_pair_table_copy['ViewData.Side1_UniqueIds']
                        final_no_pair_table_copy.loc[
                            final_no_pair_table_copy['ViewData.Side1_UniqueIds'] == 'None', 'Side0_1_UniqueIds'] = \
                            final_no_pair_table_copy['ViewData.Side0_UniqueIds']

                        final_no_pair_table_copy.loc[
                            final_no_pair_table_copy['ViewData.Side0_UniqueIds'] == 'nan', 'Side0_1_UniqueIds'] = \
                        final_no_pair_table_copy['ViewData.Side1_UniqueIds']
                        final_no_pair_table_copy.loc[
                            final_no_pair_table_copy['ViewData.Side1_UniqueIds'] == 'nan', 'Side0_1_UniqueIds'] = \
                        final_no_pair_table_copy['ViewData.Side0_UniqueIds']
                        ...
                        if (elim_except_mapped_custodian_acct_and_currency_and_umr.shape[0] != 0):
                            updown_ids_a_side = elim_except_mapped_custodian_acct_and_currency_and_umr[
                                'Side1_UniqueIds'].unique()
                            updown_ids_b_side = elim_except_mapped_custodian_acct_and_currency_and_umr[
                                'Side0_UniqueIds'].unique()
                        else:
                            updown_ids_a_side = []
                            updown_ids_b_side = []
                        ...
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before Xtest left')

                        ### Remove Updown IDs

                        X_test_left = X_test[~(X_test['SideB.ViewData.Side0_UniqueIds'].isin(updown_ids_b_side))]
                        X_test_left = X_test_left[
                            ~(X_test_left['SideA.ViewData.Side1_UniqueIds'].isin(updown_ids_a_side))]

                        ### Remove Open IDs

                        X_test_left = X_test_left[
                            ~(X_test_left['SideB.ViewData.Side0_UniqueIds'].isin(no_pair_ids_b_side))]
                        X_test_left = X_test_left[
                            ~(X_test_left['SideA.ViewData.Side1_UniqueIds'].isin(no_pair_ids_a_side))]
                        ...
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before ccnew')
                        ...
                        cc_new = cc_new[~((cc_new['ViewData.Side0_UniqueIds'].isin(
                            final_umr_table['SideB.ViewData.Side0_UniqueIds'])) | (
                                              cc_new['ViewData.Side1_UniqueIds'].isin(
                                                  final_umr_table['SideA.ViewData.Side1_UniqueIds'])))]

                        cc_new = cc_new[~((cc_new['ViewData.Side0_UniqueIds'].isin(
                            final_umt_table['SideB.ViewData.Side0_UniqueIds'])) | (
                                              cc_new['ViewData.Side1_UniqueIds'].isin(
                                                  final_umt_table['SideA.ViewData.Side1_UniqueIds'])))]
                        ...
                        for key in cc_new['filter_key_with_sd'].unique():
                            ...
                            if (-0.25 <= cc_dummy['ViewData.Net Amount Difference'].sum() <= 0.25) & (
                                    cc_dummy.shape[0] > 2) & (cc_dummy['Trans_side'].nunique() > 1):
                                # print(cc2_dummy.shape[0])
                                # print(key)
                        ...
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After ccnew')
                        ...
                        X_test_left = X_test_left[~(X_test_left['SideA.ViewData.Side1_UniqueIds'].isin(
                            final_umr_table['SideA.ViewData.Side1_UniqueIds']))]
                        X_test_left = X_test_left[~(X_test_left['SideB.ViewData.Side0_UniqueIds'].isin(
                            final_umr_table['SideB.ViewData.Side0_UniqueIds']))]

                        X_test_left = X_test_left.drop(['SideB.ViewData._ID', 'SideA.ViewData._ID'],
                                                       1).drop_duplicates()
                        X_test_left = X_test_left.reset_index().drop('index', 1)
                        ...
                        exceptions_0_umb = X_test[X_test['Predicted_action_2'] == 'UMB_One_to_One'][
                            'SideB.ViewData.Side0_UniqueIds'].value_counts().reset_index(name='count')
                        exceptions_0_umb_ids = exceptions_0_umb[exceptions_0_umb['count'] > cliff_for_loop][
                            'index'].unique()
                        ...
                        for key in exceptions_0_umb['index'].unique():
                            ...
                            if key in exceptions_0_umb_ids:
                                sort_data = X_test[(X_test['SideB.ViewData.Side0_UniqueIds'] == key) & (
                                            X_test['Predicted_action_2'] == 'UMB_One_to_One')].sort_values(
                                    by=['probability_UMB_2'], ascending=[False])
                                ...
                                if subSum(values, net_sum) == []:
                                    ...
                                    id1_aggregation = sort_data[
                                        (sort_data['SideA.ViewData.B-P Net Amount'].isin(amount_array)) & (
                                                    sort_data['SideB.ViewData.Side0_UniqueIds'] == key)][
                                        'SideA.ViewData.Side1_UniqueIds'].values
                                    id0_unique = key
                                ...
                                sort_data2 = X_test[(X_test['SideB.ViewData.Side0_UniqueIds'] == key) & (
                                            X_test['Predicted_action_2'] == 'UMB_One_to_One')].sort_values(
                                    by=['probability_UMB_2'], ascending=[False])
                                ...
                                if subSum(values, net_sum) == []:
                                    ...
                                    id1_aggregation = sort_data2[
                                        (sort_data2['SideA.ViewData.B-P Net Amount'].isin(amount_array)) & (
                                                    sort_data2['SideB.ViewData.Side0_UniqueIds'] == key)][
                                        'SideA.ViewData.Side1_UniqueIds'].values
                                    id0_unique = key
                        ...
                        if umr_otm_table.empty == False:
                            umr_otm_table = umr_otm_table[
                                umr_otm_table['SideB.ViewData.Side0_UniqueIds'].isin(one_id_0_final)]

                        filtered_otm_flat = [item for sublist in filtered_otm for item in sublist]

                        # ## Including UMR double count into OTM

                        umr_double_count = X_test.groupby(['SideB.ViewData.Side0_UniqueIds'])[
                            'Predicted_action'].value_counts().reset_index(name='count')
                        umr_double_count = umr_double_count[
                            (umr_double_count['Predicted_action'] == 'UMR_One_to_One') & (
                                        umr_double_count['count'] == 2)]
                        ...
                        if umr_double_count.empty == False:
                            umr_double_count_left = umr_double_count[
                                ~umr_double_count['SideB.ViewData.Side0_UniqueIds'].isin(sideb_unique)]
                        else:
                        ...
                        if (umr_double_count_left.shape[0] != 0):
                            for key in umr_double_count_left['SideB.ViewData.Side0_UniqueIds'].unique():
                                acc_amount = X_test[X_test['SideB.ViewData.Side0_UniqueIds'] == key][
                                    'SideB.ViewData.Accounting Net Amount'].max()
                                pb_ids_otm = X_test[(X_test['SideB.ViewData.Side0_UniqueIds'] == key) & ((X_test[
                                                                                                              'SideB.ViewData.Accounting Net Amount'] ==
                                                                                                          X_test[
                                                                                                              'SideA.ViewData.B-P Net Amount']) | (
                                                                                                                     X_test[
                        ...
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After umr otm table loop')
                        ...
                        exceptions_1_umb = X_test[X_test['Predicted_action_2'] == 'UMB_One_to_One'][
                            'SideA.ViewData.Side1_UniqueIds'].value_counts().reset_index(name='count')
                        exceptions_1_umb_ids = exceptions_1_umb[exceptions_1_umb['count'] > cliff_for_loop][
                            'index'].unique()
                        ...
                        for key in exceptions_1_umb['index'].unique():
                            ...
                            if key in exceptions_1_umb_ids:
                                sort_data = X_test[(X_test['SideA.ViewData.Side1_UniqueIds'] == key) & (
                                            X_test['Predicted_action_2'] == 'UMB_One_to_One')].sort_values(
                                    by=['probability_UMB_2'], ascending=[False])
                                sort_data = sort_data.reset_index().drop('index', 1)
                                ...
                                if subSum(values2, net_sum2) == []:
                                    ...
                                    id0_aggregation = sort_data[
                                        (sort_data['SideB.ViewData.Accounting Net Amount'].isin(amount_array2)) & (
                                                sort_data['SideA.ViewData.Side1_UniqueIds'] == key)][
                                        'SideB.ViewData.Side0_UniqueIds'].values
                                    id1_unique = key
                                ...
                                sort_data2 = X_test[(X_test['SideA.ViewData.Side1_UniqueIds'] == key) & (
                                            X_test['Predicted_action_2'] == 'UMB_One_to_One')].sort_values(
                                    by=['probability_UMB_2'], ascending=[False])
                                sort_data2 = sort_data2.reset_index().drop('index', 1)
                                ...
                                if subSum(values2, net_sum2) == []:
                                    ...
                                    id0_aggregation = sort_data2[
                                        (sort_data2['SideB.ViewData.Accounting Net Amount'].isin(amount_array2)) & (
                                                    sort_data2['SideA.ViewData.Side1_UniqueIds'] == key)][
                                        'SideB.ViewData.Side0_UniqueIds'].values
                                    id1_unique = key
                        ...
                        if (umr_mto_table.empty == False):
                            umr_mto_table = umr_mto_table[
                                umr_mto_table['SideA.ViewData.Side1_UniqueIds'].isin(one_id_1_final)]
                            umr_mto_table = umr_mto_table.reset_index().drop('index', 1)
                        ...
                        mem_diff_m_after_umr_mto_table_loop = m_after_umr_mto_table_loop[0] - \
                                                              m_after_umr_otm_table_loop[0]
                        print(f"It took {mem_diff_m_after_umr_mto_table_loop} Mb to execute this method")
                        Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After umr mto table loop')
                        ...
                        X_test_left2 = X_test_left[
                            ~(X_test_left['SideB.ViewData.Side0_UniqueIds'].isin(filtered_mto_flat))]

                        X_test_left2 = X_test_left2[
                            ~(X_test_left2['SideA.ViewData.Side1_UniqueIds'].isin(list(one_id_1)))]

                        # X_test_left2 = X_test_left2[~(X_test_left2['SideA.ViewData.Side1_UniqueIds'].isin(list(np.concatenate(many_ids_1))))]

                        X_test_left2 = X_test_left[
                            ~(X_test_left['SideB.ViewData.Side0_UniqueIds'].isin(filtered_otm_flat))]
                        X_test_left2 = X_test_left2[
                            ~(X_test_left2['SideB.ViewData.Side0_UniqueIds'].isin(list(one_id_0)))]
                        ...
                        def one_to_one_umb(data):
                            ...
                            id1s = data[data['SideB.ViewData.Side0_UniqueIds'].isin(id0s)][
                                'SideA.ViewData.Side1_UniqueIds']
                        ...
                        final_oto_umb_table = X_test_umb[
                            X_test_umb['SideA.ViewData.Side1_UniqueIds'].isin(one_side_unique_umb_ids)]

                        final_oto_umb_table = final_oto_umb_table[
                            ['SideB.ViewData.Side0_UniqueIds', 'SideA.ViewData.Side1_UniqueIds',
                             'SideB.ViewData.BreakID_B_side', 'SideA.ViewData.BreakID_A_side', 'Predicted_action_2',
                             'probability_No_pair_2', 'probability_UMB_2', 'probability_UMR']]

                        final_oto_umb_table['probability_UMR'] = 0.00010
                        final_oto_umb_table = final_oto_umb_table.rename(
                            columns={'Predicted_action_2': 'Predicted_action',
                                     'probability_No_pair_2': 'probability_No_pair',
                                     'probability_UMB_2': 'probability_UMB'})

                        # ## Removing IDs from OTO UMB

                        X_test_left3 = X_test_left2[~(X_test_left2['SideB.ViewData.Side0_UniqueIds'].isin(
                            final_oto_umb_table['SideB.ViewData.Side0_UniqueIds']))]
                        X_test_left3 = X_test_left3[~(X_test_left3['SideA.ViewData.Side1_UniqueIds'].isin(
                            final_oto_umb_table['SideA.ViewData.Side1_UniqueIds']))]
                        ...
                        def no_pair_seg2(X_test):
                            if (X_test.shape[0] != 0):
                                ...
                                b_side_agg['No_Pair_flag'] = b_side_agg['Predicted_action'].apply(
                                    lambda x: 1 if 'No-Pair' in x else 0)

                                a_side_agg['len'] = a_side_agg['Predicted_action'].str.len()
                                a_side_agg['No_Pair_flag'] = a_side_agg['Predicted_action'].apply(
                                    lambda x: 1 if 'No-Pair' in x else 0)
                        ...
                        X_test_left4 = X_test_left3[~(
                                    (X_test_left3['SideB.ViewData.Side0_UniqueIds'].isin(open_ids_0_last)) | (
                                X_test_left3['SideA.ViewData.Side1_UniqueIds'].isin(open_ids_1_last)))]
                        ...
                        if (mtm_df_sd.shape[0] != 0):
                            ...
                            if mtm_df_sd['len_1'].max() == 1:
                                ...
                                new_mto1 = new_mto1.rename(
                                    columns={'ViewData.Side0_UniqueIds': 'SideB.ViewData.Side0_UniqueIds',
                                             'ViewData.Side1_UniqueIds': 'SideA.ViewData.Side1_UniqueIds'})
                            else:
                                if mtm_df_sd['len_0'].max() == 1:
                                    new_otm1 = mtm_df_sd[mtm_df_sd['len_0'] == 1].drop(['len_1', 'len_0'], 1)
                                    new_otm1 = new_otm1.rename(
                                        columns={'ViewData.Side0_UniqueIds': 'SideB.ViewData.Side0_UniqueIds',
                                                 'ViewData.Side1_UniqueIds': 'SideA.ViewData.Side1_UniqueIds'})
                        ...
                        if (mtm_df_sd.shape[0] != 0):
                            ...
                            if mtm_df_sd[(mtm_df_sd['len_1'] > 1) & (mtm_df_sd['len_0'] > 1)].empty == False:
                                new_mtm1 = mtm_df_sd[(mtm_df_sd['len_1'] > 1) & (mtm_df_sd['len_0'] > 1)].drop(
                                    ['len_1', 'len_0'], 1)
                                new_mtm1 = new_mtm1.reset_index().drop('index', 1)
                                new_mtm1 = new_mtm1.rename(
                                    columns={'ViewData.Side0_UniqueIds': 'SideB.ViewData.Side0_UniqueIds',
                                             'ViewData.Side1_UniqueIds': 'SideA.ViewData.Side1_UniqueIds'})

                        if (mtm_df_eqs.shape[0] != 0):
                            if mtm_df_eqs[(mtm_df_eqs['len_1'] > 1) & (mtm_df_eqs['len_0'] > 1)].empty == False:
                                new_mtm2 = mtm_df_eqs[(mtm_df_eqs['len_1'] > 1) & (mtm_df_eqs['len_0'] > 1)].drop(
                                    ['len_1', 'len_0'], 1)
                                new_mtm2 = new_mtm2.reset_index().drop('index', 1)
                                new_mtm2 = new_mtm2.rename(
                                    columns={'ViewData.Side0_UniqueIds': 'SideB.ViewData.Side0_UniqueIds',
                                             'ViewData.Side1_UniqueIds': 'SideA.ViewData.Side1_UniqueIds'})
                        ...
                        if final_otm_table.shape[0] > 0:
                            otm_flat_new = [item for sublist in final_otm_table['SideA.ViewData.Side1_UniqueIds'].values
                                            for item in sublist] + list(
                                final_otm_table['SideB.ViewData.Side0_UniqueIds'].values)
                        else:
                            otm_flat_new = ['None', 'nan']

                        if final_mto_table.shape[0] > 0:
                            mto_flat_new = [item for sublist in final_mto_table['SideB.ViewData.Side0_UniqueIds'].values
                                            for item in sublist] + list(
                                final_mto_table['SideA.ViewData.Side1_UniqueIds'].values)
                        else:
                        ...
                        if final_mtm_table.shape[0] > 0:
                            final_mtm_table['zero_dup_flag'] = final_mtm_table['SideB.ViewData.Side0_UniqueIds'].apply(
                                lambda x: 1 if any(key in x for key in total_flat_new) else 0)
                            final_mtm_table['one_dup_flag'] = final_mtm_table['SideA.ViewData.Side1_UniqueIds'].apply(
                                lambda x: 1 if any(key in x for key in total_flat_new) else 0)
                            final_mtm_table = final_mtm_table[
                                (final_mtm_table['zero_dup_flag'] == 0) & (final_mtm_table['one_dup_flag'] == 0)]
                            final_mtm_table = final_mtm_table.reset_index().drop('index', 1)
                        ...
                        final_umr_table_copy = normalize_final_no_pair_table_col_names(
                            fun_final_no_pair_table=final_umr_table_copy)
                        #
                        final_umr_table_copy['ViewData.Side0_UniqueIds'] = final_umr_table_copy[
                            'ViewData.Side0_UniqueIds'].astype(str)
                        final_umr_table_copy['ViewData.Side1_UniqueIds'] = final_umr_table_copy[
                            'ViewData.Side1_UniqueIds'].astype(str)

                        final_umr_table_copy_new = pd.merge(final_umr_table_copy, meo_df[
                            ['ViewData.Side1_UniqueIds', 'ViewData.Task ID', 'ViewData.Task Business Date',
                             'ViewData.Source Combination Code']].drop_duplicates(), on='ViewData.Side1_UniqueIds',
                                                            how='left')
                        #    #no_pair_ids_df = no_pair_ids_df.rename(columns={'0':'filter_key'})
                        ...
                        final_umr_table_copy_new.rename(
                            columns=change_names_of_filepaths_final_umr_table_copy_new_mapping_dict, inplace=True)

                        final_umr_table_copy_new['Task Business Date'] = pd.to_datetime(
                            final_umr_table_copy_new['Task Business Date'])
                        final_umr_table_copy_new['Task Business Date'] = final_umr_table_copy_new[
                            'Task Business Date'].map(lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                        final_umr_table_copy_new['Task Business Date'] = pd.to_datetime(
                            final_umr_table_copy_new['Task Business Date'])
                        ...
                        final_umr_table_copy_new[
                            ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                             'probability_No_pair', 'probability_UMB', 'probability_UMR', 'probability_UMT',
                             'Source Combination Code', 'Predicted_Status', 'ML_flag', 'PredictedComment']] = \
                            final_umr_table_copy_new[
                            ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                             'probability_No_pair', 'probability_UMB', 'probability_UMR', 'probability_UMT',
                             'Source Combination Code', 'Predicted_Status', 'ML_flag', 'PredictedComment']].astype(str)

                        final_umr_table_copy_new[['BreakID', 'Task ID']] = final_umr_table_copy_new[
                            ['BreakID', 'Task ID']].astype(float)
                        final_umr_table_copy_new[['BreakID', 'Task ID']] = final_umr_table_copy_new[
                            ['BreakID', 'Task ID']].astype(np.int64)
                        ...
                        final_umr_table_copy_new.rename(columns=change_col_names_final_umr_table_copy_new_new_dict,
                                                        inplace=True)
...
#                        filepaths_final_umr_table_copy_new_to_write = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_umr_table_copy_new_to_write_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        final_umt_table_copy = normalize_final_no_pair_table_col_names(
                            fun_final_no_pair_table=final_umt_table_copy)
                        #
                        final_umt_table_copy['ViewData.Side0_UniqueIds'] = final_umt_table_copy[
                            'ViewData.Side0_UniqueIds'].astype(str)
                        final_umt_table_copy['ViewData.Side1_UniqueIds'] = final_umt_table_copy[
                            'ViewData.Side1_UniqueIds'].astype(str)

                        final_umt_table_copy_new = pd.merge(final_umt_table_copy, meo_df[
                            ['ViewData.Side1_UniqueIds', 'ViewData.Task ID', 'ViewData.Task Business Date',
                             'ViewData.Source Combination Code']].drop_duplicates(), on='ViewData.Side1_UniqueIds',
                                                            how='left')
                        #    #no_pair_ids_df = no_pair_ids_df.rename(columns={'0':'filter_key'})
                        ...
                        final_umt_table_copy_new.rename(
                            columns=change_names_of_filepaths_final_umt_table_copy_new_mapping_dict, inplace=True)

                        final_umt_table_copy_new['Task Business Date'] = pd.to_datetime(
                            final_umt_table_copy_new['Task Business Date'])
                        final_umt_table_copy_new['Task Business Date'] = final_umt_table_copy_new[
                            'Task Business Date'].map(lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                        final_umt_table_copy_new['Task Business Date'] = pd.to_datetime(
                            final_umt_table_copy_new['Task Business Date'])
                        ...
                        final_umt_table_copy_new[['BreakID', 'Task ID']] = final_umt_table_copy_new[
                            ['BreakID', 'Task ID']].astype(float)
                        final_umt_table_copy_new[['BreakID', 'Task ID']] = final_umt_table_copy_new[
                            ['BreakID', 'Task ID']].astype(np.int64)
                        ...
                        final_umt_table_copy_new.rename(columns=change_col_names_final_umt_table_copy_new_new_dict,
                                                        inplace=True)
...
#                        filepaths_final_umt_table_copy_new_to_write = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_umt_table_copy_new_to_write_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        no_pair_ids_last_df = no_pair_ids_last_df[
                            ~no_pair_ids_last_df['Side0_1_UniqueIds'].isin(['None'])]

                        final_no_pair_table_copy_1 = final_no_pair_table_copy.append(
                            [no_pair_ids_df, no_pair_ids_last_df])
                        if (final_mto_table.shape[0] != 0):
                            final_mto_table['SideA.ViewData.Side1_UniqueIds'] = final_mto_table[
                                'SideA.ViewData.Side1_UniqueIds'].astype(str).apply(
                                lambda x: x.replace('[', '').replace(']', '').replace('\'', '').strip())
                        if (final_otm_table.shape[0] != 0):
                            final_otm_table['SideB.ViewData.Side0_UniqueIds'] = final_otm_table[
                                'SideB.ViewData.Side0_UniqueIds'].astype(str).apply(
                                lambda x: x.replace('[', '').replace(']', '').replace('\'', '').strip())

                        if (final_mto_table.shape[0] != 0):
                            final_mto_table_side_0_ids_to_remove_from_no_pair_table_list = list(
                                set(np.concatenate(final_mto_table['SideB.ViewData.Side0_UniqueIds'])))
                            final_mto_table_side_1_ids_to_remove_from_no_pair_table_list = list(
                                set(final_mto_table['SideA.ViewData.Side1_UniqueIds']))
                            final_no_pair_table_copy_1 = final_no_pair_table_copy_1[
                                ~final_no_pair_table_copy_1['Side0_1_UniqueIds'].isin(
                                    final_mto_table_side_0_ids_to_remove_from_no_pair_table_list)]
                            final_no_pair_table_copy_1 = final_no_pair_table_copy_1[
                                ~final_no_pair_table_copy_1['Side0_1_UniqueIds'].isin(
                                    final_mto_table_side_1_ids_to_remove_from_no_pair_table_list)]

                        if (final_otm_table.shape[0] != 0):
                            final_otm_table_side_0_ids_to_remove_from_no_pair_table_list = list(
                                set(final_otm_table['SideB.ViewData.Side0_UniqueIds']))
                            final_otm_table_side_1_ids_to_remove_from_no_pair_table_list = list(
                                set(np.concatenate(final_otm_table['SideA.ViewData.Side1_UniqueIds'])))
                            final_no_pair_table_copy_1 = final_no_pair_table_copy_1[
                                ~final_no_pair_table_copy_1['Side0_1_UniqueIds'].isin(
                                    final_otm_table_side_0_ids_to_remove_from_no_pair_table_list)]
                            final_no_pair_table_copy_1 = final_no_pair_table_copy_1[
                                ~final_no_pair_table_copy_1['Side0_1_UniqueIds'].isin(
                                    final_otm_table_side_1_ids_to_remove_from_no_pair_table_list)]

                        if (final_mtm_table.shape[0] != 0):
                            final_mtm_table_side_0_ids_to_remove_from_no_pair_table_list = list(
                                set(np.concatenate(final_mtm_table['SideB.ViewData.Side0_UniqueIds'])))
                            final_mtm_table_side_1_ids_to_remove_from_no_pair_table_list = list(
                                set(np.concatenate(final_mtm_table['SideA.ViewData.Side1_UniqueIds'])))
                            final_no_pair_table_copy_1 = final_no_pair_table_copy_1[
                                ~final_no_pair_table_copy_1['Side0_1_UniqueIds'].isin(
                                    final_mtm_table_side_0_ids_to_remove_from_no_pair_table_list)]
                            final_no_pair_table_copy_1 = final_no_pair_table_copy_1[
                                ~final_no_pair_table_copy_1['Side0_1_UniqueIds'].isin(
                                    final_mtm_table_side_1_ids_to_remove_from_no_pair_table_list)]

                        final_no_pair_table_copy_1 = pd.merge(final_no_pair_table_copy_1, meo_df[
                            ['ViewData.Side1_UniqueIds', 'ViewData.BreakID', 'ViewData.Task ID',
                             'ViewData.Task Business Date', 'ViewData.Source Combination Code']].drop_duplicates(),
                                                              left_on='Side0_1_UniqueIds',
                                                              right_on='ViewData.Side1_UniqueIds', how='left')
                        final_no_pair_table_copy_1 = pd.merge(final_no_pair_table_copy_1, meo_df[
                            ['ViewData.Side0_UniqueIds', 'ViewData.BreakID', 'ViewData.Task ID',
                             'ViewData.Task Business Date', 'ViewData.Source Combination Code']].drop_duplicates(),
                                                              left_on='Side0_1_UniqueIds',
                                                              right_on='ViewData.Side0_UniqueIds', how='left')
                        #    #no_pair_ids_df = no_pair_ids_df.rename(columns={'0':'filter_key'})
                        ...
                        final_no_pair_table_copy_1['ViewData.Task ID_x'] = final_no_pair_table_copy_1[
                            'ViewData.Task ID_x'].astype(str)
                        final_no_pair_table_copy_1['ViewData.Task ID_y'] = final_no_pair_table_copy_1[
                            'ViewData.Task ID_y'].astype(str)

                        final_no_pair_table_copy_1.loc[
                            final_no_pair_table_copy_1['ViewData.Task ID_x'] == 'None', 'Task ID'] = \
                        final_no_pair_table_copy_1['ViewData.Task ID_y']
                        final_no_pair_table_copy_1.loc[
                            final_no_pair_table_copy_1['ViewData.Task ID_y'] == 'None', 'Task ID'] = \
                        final_no_pair_table_copy_1['ViewData.Task ID_x']

                        final_no_pair_table_copy_1.loc[
                            final_no_pair_table_copy_1['ViewData.Task ID_x'] == 'nan', 'Task ID'] = \
                        final_no_pair_table_copy_1['ViewData.Task ID_y']
                        final_no_pair_table_copy_1.loc[
                            final_no_pair_table_copy_1['ViewData.Task ID_y'] == 'nan', 'Task ID'] = \
                        final_no_pair_table_copy_1['ViewData.Task ID_x']
                        ...
                        final_no_pair_table_copy_1['Task ID'] = final_no_pair_table_copy_1['Task ID'].replace('\.0', '',
                                                                                                              regex=True)

                        final_no_pair_table_copy_1['ViewData.BreakID_x'] = final_no_pair_table_copy_1[
                            'ViewData.BreakID_x'].astype(str)
                        final_no_pair_table_copy_1['ViewData.BreakID_y'] = final_no_pair_table_copy_1[
                            'ViewData.BreakID_y'].astype(str)

                        final_no_pair_table_copy_1.loc[
                            final_no_pair_table_copy_1['ViewData.BreakID_x'] == 'None', 'BreakID'] = \
                        final_no_pair_table_copy_1['ViewData.BreakID_y']
                        final_no_pair_table_copy_1.loc[
                            final_no_pair_table_copy_1['ViewData.BreakID_y'] == 'None', 'BreakID'] = \
                        final_no_pair_table_copy_1['ViewData.BreakID_x']

                        final_no_pair_table_copy_1.loc[
                            final_no_pair_table_copy_1['ViewData.BreakID_x'] == 'nan', 'BreakID'] = \
                        final_no_pair_table_copy_1['ViewData.BreakID_y']
                        final_no_pair_table_copy_1.loc[
                            final_no_pair_table_copy_1['ViewData.BreakID_y'] == 'nan', 'BreakID'] = \
                        final_no_pair_table_copy_1['ViewData.BreakID_x']
                        ...
                        final_no_pair_table_copy_1['BreakID'] = final_no_pair_table_copy_1['BreakID'].replace('\.0', '',
                                                                                                              regex=True)

                        final_no_pair_table_copy_1['ViewData.Task Business Date_x'] = final_no_pair_table_copy_1[
                            'ViewData.Task Business Date_x'].astype(str)
                        final_no_pair_table_copy_1['ViewData.Task Business Date_y'] = final_no_pair_table_copy_1[
                            'ViewData.Task Business Date_y'].astype(str)

                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Task Business Date_x'] == 'None', 'Task Business Date'] = \
                        final_no_pair_table_copy_1['ViewData.Task Business Date_y']
                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Task Business Date_y'] == 'None', 'Task Business Date'] = \
                        final_no_pair_table_copy_1['ViewData.Task Business Date_x']

                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Task Business Date_x'] == 'nan', 'Task Business Date'] = \
                        final_no_pair_table_copy_1['ViewData.Task Business Date_y']
                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Task Business Date_y'] == 'nan', 'Task Business Date'] = \
                        final_no_pair_table_copy_1['ViewData.Task Business Date_x']
                        ...
                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Task Business Date_x'] == 'NaT', 'Task Business Date'] = \
                            final_no_pair_table_copy_1['ViewData.Task Business Date_y']
                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Task Business Date_y'] == 'NaT', 'Task Business Date'] = \
                            final_no_pair_table_copy_1['ViewData.Task Business Date_x']

                        final_no_pair_table_copy_1['ViewData.Source Combination Code_x'] = final_no_pair_table_copy_1[
                            'ViewData.Source Combination Code_x'].astype(str)
                        final_no_pair_table_copy_1['ViewData.Source Combination Code_y'] = final_no_pair_table_copy_1[
                            'ViewData.Source Combination Code_y'].astype(str)

                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Source Combination Code_x'] == 'None', 'Source Combination Code'] = \
                            final_no_pair_table_copy_1['ViewData.Source Combination Code_y']
                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Source Combination Code_y'] == 'None', 'Source Combination Code'] = \
                        final_no_pair_table_copy_1['ViewData.Source Combination Code_x']

                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Source Combination Code_x'] == 'nan', 'Source Combination Code'] = \
                        final_no_pair_table_copy_1['ViewData.Source Combination Code_y']
                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Source Combination Code_y'] == 'nan', 'Source Combination Code'] = \
                        final_no_pair_table_copy_1['ViewData.Source Combination Code_x']

                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Source Combination Code_x'] == 'NaT', 'Source Combination Code'] = \
                        final_no_pair_table_copy_1['ViewData.Source Combination Code_y']
                        final_no_pair_table_copy_1.loc[final_no_pair_table_copy_1[
                                                           'ViewData.Source Combination Code_y'] == 'NaT', 'Source Combination Code'] = \
                            final_no_pair_table_copy_1['ViewData.Source Combination Code_x']
                        ...
                        for i in range(0, final_no_pair_table_copy_1.shape[0]):
                            final_no_pair_table_copy_1['probability_UMT'].iloc[i] = float(
                                decimal.Decimal(random.randrange(50, 100)) / 1000)

                        final_no_pair_table_copy_1['Task Business Date'] = pd.to_datetime(
                            final_no_pair_table_copy_1['Task Business Date'])
                        final_no_pair_table_copy_1['Task Business Date'] = final_no_pair_table_copy_1[
                            'Task Business Date'].map(lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                        final_no_pair_table_copy_1['Task Business Date'] = pd.to_datetime(
                            final_no_pair_table_copy_1['Task Business Date'])
                        ...
                        final_no_pair_table_copy_1.rename(
                            columns=change_names_of_final_no_pair_table_copy_1_mapping_dict, inplace=True)
                        ...
                        final_no_pair_table_copy_1[['BreakID', 'Task ID']] = final_no_pair_table_copy_1[
                            ['BreakID', 'Task ID']].astype(float)
                        final_no_pair_table_copy_1[['BreakID', 'Task ID']] = final_no_pair_table_copy_1[
                            ['BreakID', 'Task ID']].astype(np.int64)
                        ...
                        final_no_pair_table_copy_1.rename(columns=change_col_names_final_no_pair_table_copy_1_new_dict,
                                                          inplace=True)
...
#                        filepaths_final_no_pair_table_copy_1_to_write = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_no_pair_table_copy_1_to_write' + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        if (comment_table_eq_swap.shape[0] != 0):
                            ...
                            comment_table_eq_swap_copy['ViewData.Side0_UniqueIds'] = comment_table_eq_swap_copy[
                                'ViewData.Side0_UniqueIds'].astype(str)
                            comment_table_eq_swap_copy['ViewData.Side1_UniqueIds'] = comment_table_eq_swap_copy[
                                'ViewData.Side1_UniqueIds'].astype(str)

                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.Side0_UniqueIds'] == 'None', 'Side0_1_UniqueIds'] = \
                                comment_table_eq_swap_copy['ViewData.Side1_UniqueIds']
                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.Side1_UniqueIds'] == 'None', 'Side0_1_UniqueIds'] = \
                            comment_table_eq_swap_copy['ViewData.Side0_UniqueIds']

                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.Side0_UniqueIds'] == 'nan', 'Side0_1_UniqueIds'] = \
                            comment_table_eq_swap_copy['ViewData.Side1_UniqueIds']
                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.Side1_UniqueIds'] == 'nan', 'Side0_1_UniqueIds'] = \
                            comment_table_eq_swap_copy['ViewData.Side0_UniqueIds']
                            ...
                            comment_table_eq_swap_copy = pd.merge(comment_table_eq_swap_copy, meo_df[
                                ['ViewData.Side1_UniqueIds', 'ViewData.BreakID', 'ViewData.Task ID',
                                 'ViewData.Task Business Date', 'ViewData.Source Combination Code']].drop_duplicates(),
                                                                  left_on='Side0_1_UniqueIds',
                                                                  right_on='ViewData.Side1_UniqueIds', how='left')
                            ...
                            comment_table_eq_swap_copy['ViewData.Task ID_x'] = comment_table_eq_swap_copy[
                                'ViewData.Task ID_x'].astype(str)
                            comment_table_eq_swap_copy['ViewData.Task ID_y'] = comment_table_eq_swap_copy[
                                'ViewData.Task ID_y'].astype(str)

                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.Task ID_x'] == 'None', 'Task ID'] = \
                            comment_table_eq_swap_copy['ViewData.Task ID_y']
                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.Task ID_y'] == 'None', 'Task ID'] = \
                            comment_table_eq_swap_copy['ViewData.Task ID_x']

                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.Task ID_x'] == 'nan', 'Task ID'] = \
                            comment_table_eq_swap_copy['ViewData.Task ID_y']
                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.Task ID_y'] == 'nan', 'Task ID'] = \
                            comment_table_eq_swap_copy['ViewData.Task ID_x']

                            comment_table_eq_swap_copy['ViewData.BreakID_x'] = comment_table_eq_swap_copy[
                                'ViewData.BreakID_x'].astype(str)
                            comment_table_eq_swap_copy['ViewData.BreakID_y'] = comment_table_eq_swap_copy[
                                'ViewData.BreakID_y'].astype(str)

                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.BreakID_x'] == 'None', 'BreakID'] = \
                            comment_table_eq_swap_copy['ViewData.BreakID_y']
                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.BreakID_y'] == 'None', 'BreakID'] = \
                            comment_table_eq_swap_copy['ViewData.BreakID_x']

                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.BreakID_x'] == 'nan', 'BreakID'] = \
                            comment_table_eq_swap_copy['ViewData.BreakID_y']
                            comment_table_eq_swap_copy.loc[
                                comment_table_eq_swap_copy['ViewData.BreakID_y'] == 'nan', 'BreakID'] = \
                            comment_table_eq_swap_copy['ViewData.BreakID_x']

                            comment_table_eq_swap_copy['ViewData.Task Business Date_x'] = comment_table_eq_swap_copy[
                                'ViewData.Task Business Date_x'].astype(str)
                            comment_table_eq_swap_copy['ViewData.Task Business Date_y'] = comment_table_eq_swap_copy[
                                'ViewData.Task Business Date_y'].astype(str)

                            comment_table_eq_swap_copy.loc[comment_table_eq_swap_copy[
                                                               'ViewData.Task Business Date_x'] == 'None', 'Task Business Date'] = \
                            comment_table_eq_swap_copy['ViewData.Task Business Date_y']
                            comment_table_eq_swap_copy.loc[comment_table_eq_swap_copy[
                                                               'ViewData.Task Business Date_y'] == 'None', 'Task Business Date'] = \
                            comment_table_eq_swap_copy['ViewData.Task Business Date_x']
                            ...
                            comment_table_eq_swap_copy['ViewData.Source Combination Code_x'] = \
                            comment_table_eq_swap_copy['ViewData.Source Combination Code_x'].astype(str)
                            comment_table_eq_swap_copy['ViewData.Source Combination Code_y'] = \
                            comment_table_eq_swap_copy['ViewData.Source Combination Code_y'].astype(str)
                            ...
                            for i in range(0, comment_table_eq_swap_copy.shape[0]):
                                comment_table_eq_swap_copy['probability_UMB'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)
                                comment_table_eq_swap_copy['probability_No_pair'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(950, 1000)) / 1000)
                                comment_table_eq_swap_copy['probability_UMR'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)
                                comment_table_eq_swap_copy['probability_UMT'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)

                            comment_table_eq_swap_copy['Task Business Date'] = pd.to_datetime(
                                comment_table_eq_swap_copy['Task Business Date'])
                            comment_table_eq_swap_copy['Task Business Date'] = comment_table_eq_swap_copy[
                                'Task Business Date'].map(lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                            comment_table_eq_swap_copy['Task Business Date'] = pd.to_datetime(
                                comment_table_eq_swap_copy['Task Business Date'])
                            ...
                            comment_table_eq_swap_copy.rename(
                                columns=change_names_of_comment_table_eq_swap_copy_mapping_dict, inplace=True)
                            ...
                            comment_table_eq_swap_copy[
                                ...
                                ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'probability_UMT',
                                 'Source Combination Code', 'Predicted_Status', 'ML_flag', 'PredictedComment']].astype(
                                str)

                            comment_table_eq_swap_copy[['BreakID', 'Task ID']] = comment_table_eq_swap_copy[
                                ['BreakID', 'Task ID']].astype(float)
                            comment_table_eq_swap_copy[['BreakID', 'Task ID']] = comment_table_eq_swap_copy[
                                ['BreakID', 'Task ID']].astype(np.int64)

                            comment_table_eq_swap_copy[['SetupID']] = comment_table_eq_swap_copy[['SetupID']].astype(
                                int)
                            ...
                            comment_table_eq_swap_copy.rename(
                                columns=change_col_names_comment_table_eq_swap_copy_new_dict, inplace=True)
...
#                            filepaths_comment_table_eq_swap_copy_to_write = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\comment_table_eq_swap_copy_to_write_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        if (final_smb_ob_table.shape[0] != 0):
                            ...
                            final_smb_ob_table_copy = pd.merge(final_smb_ob_table, meo_df[
                                ['ViewData.BreakID', 'ViewData.Task ID', 'ViewData.Task Business Date',
                                 'ViewData.Source Combination Code']].drop_duplicates(), left_on='BreakID_OB',
                                                               right_on='ViewData.BreakID', how='left')
                            ...
                            final_smb_ob_table_copy['ViewData.Task Business Date'] = pd.to_datetime(
                                final_smb_ob_table_copy['ViewData.Task Business Date'])
                            final_smb_ob_table_copy['ViewData.Task Business Date'] = final_smb_ob_table_copy[
                                'ViewData.Task Business Date'].map(
                                lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                            final_smb_ob_table_copy['ViewData.Task Business Date'] = pd.to_datetime(
                                final_smb_ob_table_copy['ViewData.Task Business Date'])
                            final_smb_ob_table_copy = make_Side0_Side1_columns_for_final_smb_ob_table(
                                final_smb_ob_table_copy, meo_df)
...
#                            filepaths_final_smb_ob_table_copy = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_smb_ob_table_copy_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        if (mtm_df_ex_and_fx.shape[0] != 0):
                            ...
                            mtm_df_ex_and_fx_copy['BreakID_Side1'] = mtm_df_ex_and_fx_copy[
                                'ViewData.Side1_UniqueIds'].apply( \
                                lambda x: get_BreakID_from_list_of_Side_01_UniqueIds(fun_meo_df=meo_df, \
                                                                                     fun_side_0_or_1=1, \
                                                                                     fun_str_list_Side_01_UniqueIds=x))

                            mtm_df_ex_and_fx_copy['BreakID_Side0'] = mtm_df_ex_and_fx_copy[
                                'ViewData.Side0_UniqueIds'].apply( \
                                lambda x: get_BreakID_from_list_of_Side_01_UniqueIds(fun_meo_df=meo_df, \
                                                                                     fun_side_0_or_1=0, \
                                                                                     fun_str_list_Side_01_UniqueIds=x))

                            mtm_df_ex_and_fx_copy = normalize_final_no_pair_table_col_names(
                                fun_final_no_pair_table=mtm_df_ex_and_fx_copy)
                            mtm_df_ex_and_fx_copy['ViewData.Side0_UniqueIds'] = mtm_df_ex_and_fx_copy[
                                'ViewData.Side0_UniqueIds'].astype(str)
                            mtm_df_ex_and_fx_copy['ViewData.Side1_UniqueIds'] = mtm_df_ex_and_fx_copy[
                                'ViewData.Side1_UniqueIds'].astype(str)
                            ...
                            mtm_df_ex_and_fx_copy['ViewData.Side0_UniqueIds_for_merging'] = mtm_df_ex_and_fx_copy[
                                'ViewData.Side0_UniqueIds'].map(lambda x: x.lstrip('[').rstrip(']')).apply(
                                lambda x: get_first_non_null_value(str(x)))

                            mtm_df_ex_and_fx_copy['ViewData.Side0_UniqueIds_for_merging'] = mtm_df_ex_and_fx_copy[
                                'ViewData.Side0_UniqueIds_for_merging'].astype(str)
                            mtm_df_ex_and_fx_copy['ViewData.Side0_UniqueIds_for_merging'] = mtm_df_ex_and_fx_copy[
                                'ViewData.Side0_UniqueIds_for_merging'].replace('\'', '', regex=True)

                            mtm_df_ex_and_fx_copy_new = pd.merge(mtm_df_ex_and_fx_copy, meo_df[
                                ['ViewData.Side0_UniqueIds', 'ViewData.Task ID', 'ViewData.Task Business Date',
                                 'ViewData.Source Combination Code']].drop_duplicates(),
                                                                 left_on='ViewData.Side0_UniqueIds_for_merging',
                                                                 right_on='ViewData.Side0_UniqueIds', how='left')
...
#                            filepaths_mtm_df_ex_and_fx_copy_new = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\UAT_Run\\X_Test_' + setup_code + '\\mtm_df_ex_and_fx_copy_new.csv'
                            ...
                            mtm_df_ex_and_fx_copy_new.rename(
                                columns=change_names_of_mtm_df_ex_and_fx_copy_new_mapping_dict, inplace=True)

                            mtm_df_ex_and_fx_copy_new['Task Business Date'] = pd.to_datetime(
                                mtm_df_ex_and_fx_copy_new['Task Business Date'])
                            mtm_df_ex_and_fx_copy_new['Task Business Date'] = mtm_df_ex_and_fx_copy_new[
                                'Task Business Date'].map(lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                            mtm_df_ex_and_fx_copy_new['Task Business Date'] = pd.to_datetime(
                                mtm_df_ex_and_fx_copy_new['Task Business Date'])
                            ...
                            mtm_df_ex_and_fx_copy_new[
                                ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'Source Combination Code',
                                 'Predicted_Status', 'ML_flag']] = mtm_df_ex_and_fx_copy_new[
                                ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'Source Combination Code',
                                 'Predicted_Status', 'ML_flag']].astype(str)

                            # Note that BreakID now if more than one and in a list, so we cant convert it to float and int64
                            mtm_df_ex_and_fx_copy_new[['Task ID']] = mtm_df_ex_and_fx_copy_new[['Task ID']].astype(
                                float)
                            mtm_df_ex_and_fx_copy_new[['Task ID']] = mtm_df_ex_and_fx_copy_new[['Task ID']].astype(
                                np.int64)
                            ...
                            mtm_df_ex_and_fx_copy_new.rename(columns=change_col_names_mtm_df_ex_and_fx_copy_new_dict,
                                                             inplace=True)
...
#                            filepaths_mtm_df_ex_and_fx_copy_new_to_write = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\mtm_df_ex_and_fx_copy_new_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        if (final_mto_table.shape[0] != 0):
                            ...
                            final_mto_table_copy['BreakID_Side1'] = final_mto_table_copy[
                                'SideA.ViewData.Side1_UniqueIds'].apply(
                                lambda x: meo_df[meo_df['ViewData.Side1_UniqueIds'] == x]['ViewData.BreakID'].unique())

                            final_mto_table_copy['BreakID_Side1'] = final_mto_table_copy['BreakID_Side1'].astype(int)

                            final_mto_table_copy['BreakID_Side0'] = final_mto_table_copy[
                                'SideB.ViewData.Side0_UniqueIds'].apply( \
                                lambda x: get_BreakID_from_list_of_Side_01_UniqueIds(fun_meo_df=meo_df, \
                                                                                     fun_side_0_or_1=0, \
                                                                                     fun_str_list_Side_01_UniqueIds=x))

                            final_mto_table_copy = normalize_final_no_pair_table_col_names(
                                fun_final_no_pair_table=final_mto_table_copy)
                            #
                            final_mto_table_copy['ViewData.Side0_UniqueIds'] = final_mto_table_copy[
                                'ViewData.Side0_UniqueIds'].astype(str)
                            final_mto_table_copy['ViewData.Side1_UniqueIds'] = final_mto_table_copy[
                                'ViewData.Side1_UniqueIds'].astype(str)

                            final_mto_table_copy_new = pd.merge(final_mto_table_copy, meo_df[
                                ['ViewData.Side1_UniqueIds', 'ViewData.Task ID', 'ViewData.Task Business Date',
                                 'ViewData.Source Combination Code']].drop_duplicates(), on='ViewData.Side1_UniqueIds',
                                                                how='left')
...
#                            filepaths_final_mto_table_copy = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_mto_table_copy_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                            ...
                            final_mto_table_copy_new.rename(
                                columns=change_names_of_final_mto_table_copy_new_mapping_dict, inplace=True)

                            final_mto_table_copy_new['Task Business Date'] = pd.to_datetime(
                                final_mto_table_copy_new['Task Business Date'])
                            final_mto_table_copy_new['Task Business Date'] = final_mto_table_copy_new[
                                'Task Business Date'].map(lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                            final_mto_table_copy_new['Task Business Date'] = pd.to_datetime(
                                final_mto_table_copy_new['Task Business Date'])
                            ...
                            for i in range(0, final_mto_table_copy_new.shape[0]):
                                final_mto_table_copy_new['probability_UMB'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)
                                final_mto_table_copy_new['probability_No_pair'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)
                                final_mto_table_copy_new['probability_UMR'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(950, 1000)) / 1000)
                                final_mto_table_copy_new['probability_UMT'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)

                            final_mto_table_copy_new[
                                ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'Source Combination Code',
                                 'Predicted_Status', 'ML_flag']] = final_mto_table_copy_new[
                                ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'Source Combination Code',
                                 'Predicted_Status', 'ML_flag']].astype(str)

                            final_mto_table_copy_new[['BreakID', 'Task ID']] = final_mto_table_copy_new[
                                ['BreakID', 'Task ID']].astype(float)
                            final_mto_table_copy_new[['BreakID', 'Task ID']] = final_mto_table_copy_new[
                                ['BreakID', 'Task ID']].astype(np.int64)
                            ...
                            final_mto_table_copy_new.rename(columns=change_col_names_final_mto_table_copy_new_dict,
                                                            inplace=True)
...
#                            filepaths_final_mto_table_copy_new_to_write = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_mto_table_copy_new_to_write_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        if (final_otm_table.shape[0] != 0):
                            ...
                            final_otm_table_copy['BreakID_Side0'] = final_otm_table_copy[
                                'SideB.ViewData.Side0_UniqueIds'].apply(
                                lambda x: meo_df[meo_df['ViewData.Side0_UniqueIds'] == x]['ViewData.BreakID'].unique())
                            final_otm_table_copy['BreakID_Side0'] = final_otm_table_copy['BreakID_Side0'].astype(int)

                            final_otm_table_copy['BreakID_Side1'] = final_otm_table_copy[
                                'SideA.ViewData.Side1_UniqueIds'].apply( \
                                lambda x: get_BreakID_from_list_of_Side_01_UniqueIds(fun_meo_df=meo_df, \
                                                                                     fun_side_0_or_1=1, \
                                                                                     fun_str_list_Side_01_UniqueIds=x))

                            final_otm_table_copy = normalize_final_no_pair_table_col_names(
                                fun_final_no_pair_table=final_otm_table_copy)
                            #
                            final_otm_table_copy['ViewData.Side0_UniqueIds'] = final_otm_table_copy[
                                'ViewData.Side0_UniqueIds'].astype(str)
                            final_otm_table_copy['ViewData.Side1_UniqueIds'] = final_otm_table_copy[
                                'ViewData.Side1_UniqueIds'].astype(str)

                            final_otm_table_copy_new = pd.merge(final_otm_table_copy, meo_df[
                                ['ViewData.Side0_UniqueIds', 'ViewData.Task ID', 'ViewData.Task Business Date',
                                 'ViewData.Source Combination Code']].drop_duplicates(), on='ViewData.Side0_UniqueIds',
                                                                how='left')
...
#                            filepaths_final_otm_table_copy = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\UAT_Run\\X_Test_' + setup_code + '\\final_otm_table_copy_new.csv'
                            ...
                            final_otm_table_copy_new.rename(
                                columns=change_names_of_final_otm_table_copy_new_mapping_dict, inplace=True)

                            final_otm_table_copy_new['Task Business Date'] = pd.to_datetime(
                                final_otm_table_copy_new['Task Business Date'])
                            final_otm_table_copy_new['Task Business Date'] = final_otm_table_copy_new[
                                'Task Business Date'].map(lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                            final_otm_table_copy_new['Task Business Date'] = pd.to_datetime(
                                final_otm_table_copy_new['Task Business Date'])
                            ...
                            for i in range(0, final_otm_table_copy_new.shape[0]):
                                final_otm_table_copy_new['probability_UMB'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)
                                final_otm_table_copy_new['probability_No_pair'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)
                                final_otm_table_copy_new['probability_UMR'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(950, 1000)) / 1000)
                                final_otm_table_copy_new['probability_UMT'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)

                            final_otm_table_copy_new[
                                ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'Source Combination Code',
                                 'Predicted_Status', 'ML_flag']] = final_otm_table_copy_new[
                                ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'Source Combination Code',
                                 'Predicted_Status', 'ML_flag']].astype(str)

                            final_otm_table_copy_new[['BreakID', 'Task ID']] = final_otm_table_copy_new[
                                ['BreakID', 'Task ID']].astype(float)
                            final_otm_table_copy_new[['BreakID', 'Task ID']] = final_otm_table_copy_new[
                                ['BreakID', 'Task ID']].astype(np.int64)
                            ...
                            final_otm_table_copy_new.rename(columns=change_col_names_final_otm_table_copy_new_dict,
                                                            inplace=True)
...
#                            filepaths_final_otm_table_copy_new_to_write = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_otm_table_copy_new_to_write_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        if (final_mtm_table.shape[0] != 0):
                            ...
                            final_mtm_table_copy['BreakID_Side1'] = final_mtm_table_copy[
                                'SideA.ViewData.Side1_UniqueIds'].apply( \
                                lambda x: get_BreakID_from_list_of_Side_01_UniqueIds(fun_meo_df=meo_df, \
                                                                                     fun_side_0_or_1=1, \
                                                                                     fun_str_list_Side_01_UniqueIds=x))

                            final_mtm_table_copy['BreakID_Side0'] = final_mtm_table_copy[
                                'SideB.ViewData.Side0_UniqueIds'].apply( \
                                lambda x: get_BreakID_from_list_of_Side_01_UniqueIds(fun_meo_df=meo_df, \
                                                                                     fun_side_0_or_1=0, \
                                                                                     fun_str_list_Side_01_UniqueIds=x))

                            final_mtm_table_copy = normalize_final_no_pair_table_col_names(
                                fun_final_no_pair_table=final_mtm_table_copy)
                            final_mtm_table_copy['ViewData.Side0_UniqueIds'] = final_mtm_table_copy[
                                'ViewData.Side0_UniqueIds'].astype(str)
                            final_mtm_table_copy['ViewData.Side1_UniqueIds'] = final_mtm_table_copy[
                                'ViewData.Side1_UniqueIds'].astype(str)
                            ...
                            # final_mtm_table_copy['ViewData.Side0_UniqueIds_for_merging'] = Single_Side0_UniqueId_for_merging_with_meo_df
                            # Change made on 10-12-2020. Above piece of code is wrong for merging. Commenting out above two lines of code and writing replacement code below it
                            final_mtm_table_copy['ViewData.Side0_UniqueIds_for_merging'] = final_mtm_table_copy[
                                'ViewData.Side0_UniqueIds'].map(lambda x: x.lstrip('[').rstrip(']')).apply(
                                lambda x: get_first_non_null_value(str(x)))
                            ...
                            final_mtm_table_copy_new = pd.merge(final_mtm_table_copy, meo_df[
                                ['ViewData.Side0_UniqueIds', 'ViewData.Task ID', 'ViewData.Task Business Date',
                                 'ViewData.Source Combination Code']].drop_duplicates(),
                                                                left_on='ViewData.Side0_UniqueIds_for_merging',
                                                                right_on='ViewData.Side0_UniqueIds', how='left')
...
#                            filepaths_final_mtm_table_copy_new = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_mtm_table_copy_new_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                            ...
                            final_mtm_table_copy_new.rename(
                                columns=change_names_of_final_mtm_table_copy_new_mapping_dict, inplace=True)

                            final_mtm_table_copy_new['Task Business Date'] = pd.to_datetime(
                                final_mtm_table_copy_new['Task Business Date'])
                            final_mtm_table_copy_new['Task Business Date'] = final_mtm_table_copy_new[
                                'Task Business Date'].map(lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                            final_mtm_table_copy_new['Task Business Date'] = pd.to_datetime(
                                final_mtm_table_copy_new['Task Business Date'])
                            ...
                            for i in range(0, final_mtm_table_copy_new.shape[0]):
                                final_mtm_table_copy_new['probability_UMB'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)
                                final_mtm_table_copy_new['probability_No_pair'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)
                                final_mtm_table_copy_new['probability_UMR'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(950, 1000)) / 1000)
                                final_mtm_table_copy_new['probability_UMT'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)

                            final_mtm_table_copy_new[
                                ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'Source Combination Code',
                                 'Predicted_Status', 'ML_flag']] = final_mtm_table_copy_new[
                                ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'Source Combination Code',
                                 'Predicted_Status', 'ML_flag']].astype(str)
                            ...
                            final_mtm_table_copy_new[['Task ID']] = final_mtm_table_copy_new[['Task ID']].astype(
                                np.int64)
                            ...
                            final_mtm_table_copy_new.rename(columns=change_col_names_final_mtm_table_copy_new_dict,
                                                            inplace=True)
...
#                            filepaths_final_mtm_table_copy_new_to_write = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_mtm_table_copy_new_to_write_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        if (final_oto_umb_table.shape[0] != 0):
                            ...
                            final_oto_umb_table_copy = normalize_final_no_pair_table_col_names(
                                fun_final_no_pair_table=final_oto_umb_table_copy)
                            #
                            final_oto_umb_table_copy['ViewData.Side0_UniqueIds'] = final_oto_umb_table_copy[
                                'ViewData.Side0_UniqueIds'].astype(str)
                            final_oto_umb_table_copy['ViewData.Side1_UniqueIds'] = final_oto_umb_table_copy[
                                'ViewData.Side1_UniqueIds'].astype(str)

                            final_oto_umb_table_copy_new = pd.merge(final_oto_umb_table_copy, meo_df[
                                ['ViewData.Side0_UniqueIds', 'ViewData.Task ID', 'ViewData.Task Business Date',
                                 'ViewData.Source Combination Code']].drop_duplicates(), on='ViewData.Side0_UniqueIds',
                                                                    how='left')
...
#                            filepaths_final_oto_umb_table_copy_new = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\UAT_Run\\X_Test_' + setup_code + '\\final_oto_umb_table_copy_new.csv'
                            ...
                            final_oto_umb_table_copy_new.rename(
                                columns=change_names_of_final_oto_umb_table_copy_new_mapping_dict, inplace=True)

                            final_oto_umb_table_copy_new['Task Business Date'] = pd.to_datetime(
                                final_oto_umb_table_copy_new['Task Business Date'])
                            final_oto_umb_table_copy_new['Task Business Date'] = final_oto_umb_table_copy_new[
                                'Task Business Date'].map(lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                            final_oto_umb_table_copy_new['Task Business Date'] = pd.to_datetime(
                                final_oto_umb_table_copy_new['Task Business Date'])
                            ...
                            for i in range(0, final_oto_umb_table_copy_new.shape[0]):
                                final_oto_umb_table_copy_new['probability_UMT'].iloc[i] = float(
                                    decimal.Decimal(random.randrange(17, 100)) / 1000)

                            final_oto_umb_table_copy_new[
                                ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'Source Combination Code',
                                 'Predicted_Status', 'ML_flag']] = final_oto_umb_table_copy_new[
                                ['Side0_UniqueIds', 'Side1_UniqueIds', 'Final_predicted_break', 'Predicted_action',
                                 'probability_No_pair', 'probability_UMB', 'probability_UMR', 'Source Combination Code',
                                 'Predicted_Status', 'ML_flag']].astype(str)

                            final_oto_umb_table_copy_new[['BreakID', 'Task ID']] = final_oto_umb_table_copy_new[
                                ['BreakID', 'Task ID']].astype(float)
                            final_oto_umb_table_copy_new[['BreakID', 'Task ID']] = final_oto_umb_table_copy_new[
                                ['BreakID', 'Task ID']].astype(np.int64)

                            final_oto_umb_table_copy_new[['SetupID']] = final_oto_umb_table_copy_new[
                                ['SetupID']].astype(int)
                            ...
                            final_oto_umb_table_copy_new.rename(
                                columns=change_col_names_final_oto_umb_table_copy_new_dict, inplace=True)
...
#                            filepaths_final_oto_umb_table_copy_new_to_write = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_oto_umb_table_copy_new_to_write_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                        ...
                        closed_columns_for_updation = ['ViewData.BreakID', 'ViewData.Task Business Date',
                                                       'ViewData.Side0_UniqueIds', 'ViewData.Side1_UniqueIds',
                                                       'ViewData.Source Combination Code', 'ViewData.Task ID',
                        ...
                        if (closed_df.shape[0] != 0):
                            ...
                            final_closed_df[closed_columns_for_updation] = final_closed_df[
                                closed_columns_for_updation].astype(str)
                            ...
                            final_closed_df['BusinessDate'] = final_closed_df['BusinessDate'].map(
                                lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                            final_closed_df['BusinessDate'] = pd.to_datetime(final_closed_df['BusinessDate'])
                            ...
                            final_closed_df['Final_predicted_break'] = final_closed_df['Final_predicted_break'].astype(
                                str)
                            ...
                            final_closed_df['SourceCombinationCode'] = final_closed_df['SourceCombinationCode'].astype(
                                str)
                            ...
                            final_closed_df[['BreakID', 'TaskID']] = final_closed_df[['BreakID', 'TaskID']].astype(
                                float)
                            final_closed_df[['BreakID', 'TaskID']] = final_closed_df[['BreakID', 'TaskID']].astype(
                                np.int64)
...
#                            filepaths_final_closed_df = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_closed_df_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After final_table_to_write creation')
...
#                    filepaths_meo_df = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\meo_df_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                    ...
                    def get_remaining_breakids(fun_meo_df, fun_final_df_2):
                        ...
                        fun_meo_df = fun_meo_df[
                            ~fun_meo_df['ViewData.Status'].isin(['SMT', 'HST', 'OC', 'CT', 'Archive', 'SMR'])]
                        ...
                        fun_final_df_2['Final_predicted_break'] = fun_final_df_2['Final_predicted_break'].map(
                            lambda x: x.lstrip('[').rstrip(']'))

                        BreakId_final_df_2 = unlist_comma_separated_single_quote_string_lst(
                            fun_final_df_2['BreakID'].astype(str).unique().tolist())
                        #    BreakId_final_df_2 =  final_df_2['BreakID'].astype(str).unique().tolist()

                        Final_predicted_breakId_final_df_2 = unlist_comma_separated_single_quote_string_lst(
                            fun_final_df_2['Final_predicted_break'].astype(str).unique().tolist())
                        #    for i in final_df_2['Final_predicted_break'].astype(str).unique().tolist():
                        #        if(',' in i):
                        #            print(i)
                        BreakId_meo_df = unlist_comma_separated_single_quote_string_lst(
                            fun_meo_df['ViewData.BreakID'].astype(str).unique().tolist())
                        all_breakids_in_final_df_2 = set(BreakId_final_df_2).union(
                            set(Final_predicted_breakId_final_df_2))
                    ...
                    unpredicted_breakids = get_remaining_breakids(fun_meo_df=meo_df,
                                                                  fun_final_df_2=final_table_to_write)
                    ...
                    df_to_append = meo_df[meo_df['ViewData.BreakID'].isin(unpredicted_breakids)][
                        ['ViewData.BreakID', 'ViewData.Side0_UniqueIds', 'ViewData.Side1_UniqueIds', 'ViewData.Task ID',
                         'ViewData.Status', 'ViewData.Source Combination Code']]
                    ...
                    df_to_append.loc[df_to_append['Predicted_Status'] != 'OB', 'Predicted_Status'] = df_to_append[
                                                                                                         'Predicted_Status'] + '_Not_Covered_by_ML'
                    df_to_append.loc[df_to_append['Predicted_Status'] != 'OB', 'Predicted_action'] = df_to_append[
                                                                                                         'Predicted_Status'] + '_Not_Covered_by_ML'
                    df_to_append.loc[df_to_append['Predicted_Status'] == 'OB', 'Predicted_Status'] = df_to_append[
                        'Predicted_Status']
...
#                    filepaths_df_to_append = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\df_to_append_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                    ...
                    brk['final_ID'] = brk.apply(
                        lambda row: fid1(row['Predicted_action'], row['ViewData.Side0_UniqueIds'],
                                         row['ViewData.Side1_UniqueIds']), axis=1, result_type="expand")
                    brk = brk.reset_index()
                    ...
                    df1['final_ID'] = df1.apply(
                        lambda row: fid(row['ViewData.Side0_UniqueIds'], row['ViewData.Side1_UniqueIds']), axis=1)
                    ...
                    df2['ViewData.SettlevsTrade Date'] = (
                                df2['ViewData.Settle Date1'] - df2['ViewData.Trade Date1']).dt.days
                    df2['ViewData.SettlevsTask Date'] = (
                                df2['ViewData.Task Business Date1'] - df2['ViewData.Settle Date1']).dt.days
                    df2['ViewData.TaskvsTrade Date'] = (
                                df2['ViewData.Task Business Date1'] - df2['ViewData.Trade Date1']).dt.days
                    ...
                    df2['ViewData.Transaction Type'] = df2['ViewData.Transaction Type'].apply(
                        lambda x: x.lower() if type(x) == str else x)
                    df2['ViewData.Asset Type Category'] = df2['ViewData.Asset Type Category'].apply(
                        lambda x: x.lower() if type(x) == str else x)
                    df2['ViewData.Investment Type'] = df2['ViewData.Investment Type'].apply(
                        lambda x: x.lower() if type(x) == str else x)
                    df2['ViewData.Prime Broker'] = df2['ViewData.Prime Broker'].apply(
                        lambda x: x.lower() if type(x) == str else x)
                    ...
                    df2['ViewData.Transaction Type1'] = df2['ViewData.Transaction Type'].apply(
                        lambda x: clean_mapping(x) if type(x) == str else x)
                    df2['ViewData.Asset Type Category1'] = df2['ViewData.Asset Type Category'].apply(
                        lambda x: clean_mapping(x) if type(x) == str else x)
                    df2['ViewData.Investment Type1'] = df2['ViewData.Investment Type'].apply(
                        lambda x: clean_mapping(x) if type(x) == str else x)
                    df2['ViewData.Prime Broker1'] = df2['ViewData.Prime Broker'].apply(
                        lambda x: clean_mapping(x) if type(x) == str else x)
                    ...
                    def comb_clean(x):
                        k = []
                        for item in x.split():
                            if ((is_num(item) == False) and (is_date_format(item) == False) and (
                                    date_edge_cases(item) == False)):
                                k.append(item)
                        return ' '.join(k)


                    df2['ViewData.Transaction Type1'] = df2['ViewData.Transaction Type1'].apply(
                        lambda x: comb_clean(x) if type(x) == str else x)
                    df2['ViewData.Asset Type Category1'] = df2['ViewData.Asset Type Category1'].apply(
                        lambda x: comb_clean(x) if type(x) == str else x)
                    df2['ViewData.Investment Type1'] = df2['ViewData.Investment Type1'].apply(
                        lambda x: comb_clean(x) if type(x) == str else x)
                    df2['ViewData.Prime Broker1'] = df2['ViewData.Prime Broker1'].apply(
                        lambda x: comb_clean(x) if type(x) == str else x)

                    df2['ViewData.Transaction Type1'] = df2['ViewData.Transaction Type1'].apply(
                        lambda x: 'paydown' if x == 'pay down' else x)
                    ...
                    df2['new_pb'] = df2['ViewData.Mapped Custodian Account'].apply(
                        lambda x: x.split('_')[0] if type(x) == str else x)

                    new_pb_mapping = {'GSIL': 'GS', 'CITIGM': 'CITI', 'JPMNA': 'JPM'}
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='new pb mapping declared')
                    ...
                    df2['new_pb1'] = df2.apply(
                        lambda x: x['new_pb'] if x['ViewData.Prime Broker1'] == 'kkk' else x['ViewData.Prime Broker1'],
                        axis=1)
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Cancel functions delared')
                    ...
                    data['comm_marker'] = data['ViewData.Commission'].apply(lambda x: comfun(x))
                    data['new_pb2'] = data.apply(
                        lambda x: 'Geneva' if x['ViewData.Side0_UniqueIds'] != 'AA' else x['new_pb1'], axis=1)
                    ...
                    data = data[Pre_final]
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before making df_mod_1')
                    ...
                    df_mod1['ViewData.Accounting Net Amount'] = df_mod1['ViewData.Accounting Net Amount'].replace('nan',
                                                                                                                  0)
                    df_mod1['ViewData.Accounting Net Amount'] = df_mod1['ViewData.Accounting Net Amount'].replace(
                        'None', 0)
                    df_mod1['ViewData.Accounting Net Amount'] = df_mod1['ViewData.Accounting Net Amount'].replace('', 0)

                    df_mod1['ViewData.Asset Type Category1'] = df_mod1['ViewData.Asset Type Category1'].replace('nan',
                                                                                                                'CC')
                    df_mod1['ViewData.Asset Type Category1'] = df_mod1['ViewData.Asset Type Category1'].replace('None',
                                                                                                                'CC')
                    df_mod1['ViewData.Asset Type Category1'] = df_mod1['ViewData.Asset Type Category1'].replace('',
                                                                                                                'CC')
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After making df_mod_1')
                    ...
                    df_mod1['final_ID'] = df_mod1.apply(
                        lambda row: fid(row['ViewData.Side0_UniqueIds'], row['ViewData.Side1_UniqueIds']), axis=1)
                    ...
                    def change_predicted_category_for_dividend(param_ttype,param_category):
                        if(param_ttype.lower() == 'dividend'):
                            param_category = 'dividend'
                            return(param_category)
                        else:
                            return(param_category)
                    
                    result_non_trade['predicted category'] = result_non_trade.apply(lambda x : change_predicted_category_for_dividend(x['ViewData.Transaction Type1'],x['predicted category']), axis = 1)
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After making result non trade')
                    ...
                    def comgen(x, y, z, k, m, a, b, c):
                        trade_ttype = ['buy', 'sell', 'sell short', 'cover short', 'spot fx', 'forward', 'forward fx',
                                       'spotfx', 'forwardfx']
                        ...
                        if m in trade_ttype:
                            if x != 'geneva':
                                if ((a != 0) & (b != 0)):
                                    com = k + ' ' + y + ' ' + str(z) + " " + 'for price' + ' ' + str(
                                        a) + ' and quantity' + ' ' + str(b) + ' ' + 'on trade date' + ' ' + str(
                                        c) + '. Geneva yet to book'
                                elif ((a == 0) & (b != 0)):
                                    com = k + ' ' + y + ' ' + str(z) + " " + 'for quantity' + ' ' + str(
                                        b) + ' ' + 'on trade date' + ' ' + str(c) + '. Geneva yet to book'
                                elif ((a != 0) & (b == 0)):
                                    com = k + ' ' + y + ' ' + str(z) + " " + 'for price' + ' ' + str(
                                        a) + ' ' + 'on trade date' + ' ' + str(c) + '. Geneva yet to book'
                                else:
                                    com = k + ' ' + y + ' ' + str(z) + ' ' + 'on trade date' + ' ' + str(
                                        c) + '. Geneva yet to book'
                            else:
                                if ((a != 0) & (b != 0)):
                                    com = 'Geneva' + ' ' + y + ' ' + str(z) + " " + 'for price' + ' ' + str(
                                        a) + ' and quantity' + ' ' + str(b) + ' ' + 'on trade date' + ' ' + str(
                                        c) + '.' + str(k) + ' yet to book'
                                elif ((a == 0) & (b != 0)):
                                    com = 'Geneva' + ' ' + y + ' ' + str(z) + " " + 'for quantity' + ' ' + str(
                                        b) + ' ' + 'on trade date' + ' ' + str(c) + '.' + str(k) + ' yet to book'
                                elif ((a != 0) & (b == 0)):
                                    com = 'Geneva' + ' ' + y + ' ' + str(z) + " " + 'for price' + ' ' + str(
                                        a) + ' ' + 'on trade date' + ' ' + str(c) + '.' + str(k) + ' yet to book'
                                else:
                                    com = 'Geneva' + ' ' + y + ' ' + str(z) + ' ' + 'on trade date' + ' ' + str(
                                        c) + '.' + str(k) + ' yet to book'

                        elif m in pos_break:

                            if ((a != 0) & (b != 0)):
                                com = 'No position break, Geneva to reflect jpm trade on ' + str(
                                    z) + " " + 'for price' + ' ' + str(a) + ' and quantity' + ' ' + str(b)
                            elif ((a == 0) & (b != 0)):
                                com = 'No position break, Geneva to reflect jpm trade on ' + str(
                                    z) + " " + 'for quantity' + ' ' + str(b)
                            elif ((a != 0) & (b == 0)):
                                com = 'No position break, Geneva to reflect jpm trade on ' + str(
                                    z) + " " + 'for price' + ' ' + str(a)
                            else:
                    ...
                    result_non_trade['ViewData.Quantity'] = result_non_trade['ViewData.Quantity'].apply(
                        lambda x: round(x, 1))
...
#                    Change made on 04-08-2021 ( 4th August, 2021) by Rohit to include mm-dd-yyyy format in trade date as well
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before merging comment df final with final_df')

                    final_df = final_table_to_write.merge(comment_df_final_side0, on='Side0_UniqueIds', how='left')
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After merging comment df final with final_df')
                    ...
                    final_df.loc[final_df['PredictedComment_x'] == '', 'PredictedComment'] = final_df[
                        'PredictedComment_y']
                    final_df.loc[final_df['PredictedComment_y'] == '', 'PredictedComment'] = final_df[
                        'PredictedComment_x']

                    final_df.loc[final_df['PredictedComment_x'] == 'None', 'PredictedComment'] = final_df[
                        'PredictedComment_y']
                    final_df.loc[final_df['PredictedComment_y'] == 'None', 'PredictedComment'] = final_df[
                        'PredictedComment_x']

                    final_df.loc[final_df['PredictedComment_x'] == 'nan', 'PredictedComment'] = final_df[
                        'PredictedComment_y']
                    final_df.loc[final_df['PredictedComment_y'] == 'nan', 'PredictedComment'] = final_df[
                        'PredictedComment_x']

                    final_df.loc[final_df['PredictedCategory_x'] == '', 'PredictedCategory'] = final_df[
                        'PredictedCategory_y']
                    final_df.loc[final_df['PredictedCategory_y'] == '', 'PredictedCategory'] = final_df[
                        'PredictedCategory_x']

                    final_df.loc[final_df['PredictedCategory_x'] == 'None', 'PredictedCategory'] = final_df[
                        'PredictedCategory_y']
                    final_df.loc[final_df['PredictedCategory_y'] == 'None', 'PredictedCategory'] = final_df[
                        'PredictedCategory_x']

                    final_df.loc[final_df['PredictedCategory_x'] == 'nan', 'PredictedCategory'] = final_df[
                        'PredictedCategory_y']
                    final_df.loc[final_df['PredictedCategory_y'] == 'nan', 'PredictedCategory'] = final_df[
                        'PredictedCategory_x']
                    ...
                    final_df.loc[final_df['Side1_UniqueIds_x'] == 'None', 'Side1_UniqueIds'] = final_df[
                        'Side1_UniqueIds_y']
                    final_df.loc[final_df['Side1_UniqueIds_y'] == 'None', 'Side1_UniqueIds'] = final_df[
                        'Side1_UniqueIds_x']

                    final_df.loc[final_df['Side1_UniqueIds_x'] == 'nan', 'Side1_UniqueIds'] = final_df[
                        'Side1_UniqueIds_y']
                    final_df.loc[final_df['Side1_UniqueIds_y'] == 'nan', 'Side1_UniqueIds'] = final_df[
                        'Side1_UniqueIds_x']
                    ...
                    final_df_2.loc[final_df_2['PredictedComment_x'] == '', 'PredictedComment'] = final_df_2[
                        'PredictedComment_y']
                    final_df_2.loc[final_df_2['PredictedComment_y'] == '', 'PredictedComment'] = final_df_2[
                        'PredictedComment_x']

                    final_df_2.loc[final_df_2['PredictedComment_x'] == 'None', 'PredictedComment'] = final_df_2[
                        'PredictedComment_y']
                    final_df_2.loc[final_df_2['PredictedComment_y'] == 'None', 'PredictedComment'] = final_df_2[
                        'PredictedComment_x']

                    final_df_2.loc[final_df_2['PredictedComment_x'] == 'nan', 'PredictedComment'] = final_df_2[
                        'PredictedComment_y']
                    final_df_2.loc[final_df_2['PredictedComment_y'] == 'nan', 'PredictedComment'] = final_df_2[
                        'PredictedComment_x']

                    final_df_2.loc[final_df_2['PredictedCategory_x'] == '', 'PredictedCategory'] = final_df_2[
                        'PredictedCategory_y']
                    final_df_2.loc[final_df_2['PredictedCategory_y'] == '', 'PredictedCategory'] = final_df_2[
                        'PredictedCategory_x']

                    final_df_2.loc[final_df_2['PredictedCategory_x'] == 'None', 'PredictedCategory'] = final_df_2[
                        'PredictedCategory_y']
                    final_df_2.loc[final_df_2['PredictedCategory_y'] == 'None', 'PredictedCategory'] = final_df_2[
                        'PredictedCategory_x']

                    final_df_2.loc[final_df_2['PredictedCategory_x'] == 'nan', 'PredictedCategory'] = final_df_2[
                        'PredictedCategory_y']
                    final_df_2.loc[final_df_2['PredictedCategory_y'] == 'nan', 'PredictedCategory'] = final_df_2[
                        'PredictedCategory_x']

                    final_df_2.loc[final_df_2['Side0_UniqueIds_x'] == '', 'Side0_UniqueIds'] = final_df_2[
                        'Side0_UniqueIds_y']
                    final_df_2.loc[final_df_2['Side0_UniqueIds_y'] == '', 'Side0_UniqueIds'] = final_df_2[
                        'Side0_UniqueIds_x']

                    final_df_2.loc[final_df_2['Side0_UniqueIds_x'] == 'None', 'Side0_UniqueIds'] = final_df_2[
                        'Side0_UniqueIds_y']
                    final_df_2.loc[final_df_2['Side0_UniqueIds_y'] == 'None', 'Side0_UniqueIds'] = final_df_2[
                        'Side0_UniqueIds_x']

                    final_df_2.loc[final_df_2['Side0_UniqueIds_x'] == 'nan', 'Side0_UniqueIds'] = final_df_2[
                        'Side0_UniqueIds_y']
                    final_df_2.loc[final_df_2['Side0_UniqueIds_y'] == 'nan', 'Side0_UniqueIds'] = final_df_2[
                        'Side0_UniqueIds_x']
                    ...
                    final_df_2['Side1_UniqueIds'] = final_df_2['Side1_UniqueIds'].map(
                        lambda x: x.lstrip('[').rstrip(']'))
                    final_df_2['Side0_UniqueIds'] = final_df_2['Side0_UniqueIds'].map(
                        lambda x: x.lstrip('[').rstrip(']'))
                    final_df_2['BreakID'] = final_df_2['BreakID'].map(lambda x: x.lstrip('[').rstrip(']'))
                    final_df_2['Final_predicted_break'] = final_df_2['Final_predicted_break'].map(
                        lambda x: x.lstrip('[').rstrip(']'))
                    ...
                    final_df_2_UMR_record_with_predicted_comment = final_df_2[
                        ((final_df_2['PredictedComment'] != '') & (final_df_2['Predicted_Status'] == 'UMR'))]

                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before removing Side01 id of OB record')

                    if (final_df_2_UMR_record_with_predicted_comment.shape[0] != 0):
                        final_df_2 = final_df_2[
                            ~((final_df_2['PredictedComment'] != '') & (final_df_2['Predicted_Status'] == 'UMR'))]

                        Side0_id_of_OB_record_to_remove_corresponding_to_UMR_record_with_predicted_comment = \
                        final_df_2_UMR_record_with_predicted_comment['Side0_UniqueIds']
                        Side1_id_of_OB_record_to_remove_corresponding_to_UMR_record_with_predicted_comment = \
                        final_df_2_UMR_record_with_predicted_comment['Side1_UniqueIds']

                        final_df_2 = final_df_2[~((final_df_2['Side0_UniqueIds'].isin(
                            Side0_id_of_OB_record_to_remove_corresponding_to_UMR_record_with_predicted_comment)) & (
                                                              final_df_2['Predicted_Status'] == 'OB'))]
                        final_df_2 = final_df_2[~((final_df_2['Side1_UniqueIds'].isin(
                            Side1_id_of_OB_record_to_remove_corresponding_to_UMR_record_with_predicted_comment)) & (
                                                              final_df_2['Predicted_Status'] == 'OB'))]
                    ...
                    final_df_2_UMT_record_with_predicted_comment = final_df_2[
                        ((final_df_2['PredictedComment'] != '') & (final_df_2['Predicted_Status'] == 'UMT'))]

                    if (final_df_2_UMT_record_with_predicted_comment.shape[0] != 0):
                        final_df_2 = final_df_2[
                            ~((final_df_2['PredictedComment'] != '') & (final_df_2['Predicted_Status'] == 'UMT'))]

                        Side0_id_of_OB_record_to_remove_corresponding_to_UMT_record_with_predicted_comment = \
                        final_df_2_UMT_record_with_predicted_comment['Side0_UniqueIds']
                        Side1_id_of_OB_record_to_remove_corresponding_to_UMT_record_with_predicted_comment = \
                        final_df_2_UMT_record_with_predicted_comment['Side1_UniqueIds']
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After removing Side01 id of OB record')

                    final_df_2['BreakID'] = final_df_2['BreakID'].astype(str)
                    final_df_2['BusinessDate'] = pd.to_datetime(final_df_2['BusinessDate'])
                    final_df_2['BusinessDate'] = final_df_2['BusinessDate'].map(
                        lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                    final_df_2['BusinessDate'] = pd.to_datetime(final_df_2['BusinessDate'])
                    ...
                    final_df_2_Covered_by_ML_df = final_df_2[
                        ~final_df_2['Predicted_Status'].str.lower().str.endswith(Search_term)]

                    final_df_2_Not_Covered_by_ML_df = final_df_2[
                        final_df_2['Predicted_Status'].str.lower().str.endswith(Search_term)]
                    ...
                    final_df_2_Not_Covered_by_ML_df['Predicted_Status'] = final_df_2_Not_Covered_by_ML_df[
                        'Predicted_Status'].apply(lambda x: get_first_term_before_separator(x, '_'))
                    ...
                    final_df_2['BreakID'] = final_df_2['BreakID'].replace('\.0', '', regex=True)
                    final_df_2['Final_predicted_break'] = final_df_2['Final_predicted_break'].replace('\.0', '',
                                                                                                      regex=True)

                    umb_ids_to_convert_to_smb = list(final_df_2[((final_df_2['Final_predicted_break'] == '') & (
                                final_df_2['Predicted_Status'] == 'UMB') & (final_df_2['PredictedComment'] == ''))][
                                                         'BreakID'])
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After getting first term before separator and making amends')
...
#                        sd = sd[6:10] + '-' + sd[0:2] + '-' + sd[3:5]
                    ...
                    meo_df_smb_comment = meo_df[meo_df['ViewData.BreakID'].isin(smb_breakids_int)][
                        ['ViewData.BreakID', 'ViewData.Settle Date', 'ViewData.Prime Broker',
                         'ViewData.Transaction Type']]
                    ...
                    if (meo_df_smb_comment.shape[0] != 0):
                        meo_df_smb_comment['PredictedComment_SMB'] = meo_df_smb_comment.apply(
                            lambda x: smb_comment(x['ViewData.Settle Date'], x['ViewData.Prime Broker'],
                                                  x['ViewData.Transaction Type']), axis=1)
                        meo_df_smb_comment['ViewData.BreakID'] = meo_df_smb_comment['ViewData.BreakID'].astype(str)

                        meo_df_smb_comment.drop(
                            columns=['ViewData.Settle Date', 'ViewData.Prime Broker', 'ViewData.Transaction Type'],
                            axis=1, inplace=True)
                        ...
                        final_df_2['PredictedComment_SMB'] = final_df_2['PredictedComment_SMB'].replace('nan', '',
                                                                                                        regex=True)
                        final_df_2['PredictedComment_SMB'] = final_df_2['PredictedComment_SMB'].replace('None', '',
                                                                                                        regex=True)

                        final_df_2['PredictedComment'] = final_df_2.apply(
                            lambda row: predicted_comment_smb_integrate_row_apply(row), axis=1, result_type="expand")
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After SMB commenting')

                    # UMB commenting
                    not_umb_breakids_for_commenting_df = final_df_2[
                        ~((final_df_2['Predicted_Status'] == 'UMB') & (final_df_2['PredictedComment'] == ''))]

                    umb_breakids_for_commenting_df = final_df_2[
                        ((final_df_2['Predicted_Status'] == 'UMB') & (final_df_2['PredictedComment'] == ''))]

                    umb_breakids_for_commenting_df['Side0ID_to_use_in_commenting'] = umb_breakids_for_commenting_df[
                        'Side0_UniqueIds'].apply(
                        lambda x: x.split(',')[0].replace('[', '').replace(']', '').replace('\'', ''))
                    umb_breakids_for_commenting_df['Side1ID_to_use_in_commenting'] = umb_breakids_for_commenting_df[
                        'Side1_UniqueIds'].apply(
                        lambda x: x.split(',')[0].replace('[', '').replace(']', '').replace('\'', ''))
                    ...
                    def breakid_corresponding_to_side01id(fun_side01_ids, fun_side, fun_meo_df):
                        if (fun_side == 0):
                            return (
                            fun_meo_df[fun_meo_df['ViewData.Side0_UniqueIds'] == fun_side01_ids]['ViewData.BreakID'])
                        elif (fun_side == 1):
                            return (
                            fun_meo_df[fun_meo_df['ViewData.Side1_UniqueIds'] == fun_side01_ids]['ViewData.BreakID'])


                    umb_breakids_for_commenting_df['BreakID0_to_use_in_commenting'] = umb_breakids_for_commenting_df[
                        'Side0ID_to_use_in_commenting'].apply(
                        lambda x: str(list(breakid_corresponding_to_side01id(x, 0, meo_df))[0]).replace('[',
                                                                                                        '').replace(']',
                                                                                                                    '').replace(
                            '\'', ''))
                    umb_breakids_for_commenting_df['BreakID1_to_use_in_commenting'] = umb_breakids_for_commenting_df[
                        'Side1ID_to_use_in_commenting'].apply(
                        lambda x: str(list(breakid_corresponding_to_side01id(x, 1, meo_df))[0]).replace('[',
                                                                                                        '').replace(']',
                                                                                                                    '').replace(
                            '\'', ''))
...
#                        sd = sd[6:10] + '-' + sd[0:2] + '-' + sd[3:5]
                    ...
                    if (umb_breakids_for_commenting_df.shape[0] != 0):
                        umb_breakids_for_commenting_df['PredictedComment'] = umb_breakids_for_commenting_df.apply(
                            lambda x: umb_comment(int(x['BreakID0_to_use_in_commenting']),
                                                  int(x['BreakID0_to_use_in_commenting'])), axis=1)

                        umb_breakids_for_commenting_df.drop(
                            columns=['Side0ID_to_use_in_commenting', 'Side1ID_to_use_in_commenting',
                                     'BreakID1_to_use_in_commenting', 'BreakID0_to_use_in_commenting'], axis=1,
                            inplace=True)

                    final_df_2 = umb_breakids_for_commenting_df.append(not_umb_breakids_for_commenting_df)

                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After UMB commenting')

                    # Change made by Rohit on 07-12-2020 to add action columns for UI
                    def ui_action_column(param_final_df):
                        param_final_df.loc[
                            ((param_final_df['ML_flag'] == 'Not_Covered_by_ML')), 'ActionType'] = 'No Prediction'
                        param_final_df.loc[((param_final_df['Predicted_Status'].isin(['OB', 'SMB'])) & (
                                    param_final_df['PredictedComment'] == '') & (
                                                        param_final_df['ML_flag'] == 'ML')), 'ActionType'] = 'No Action'
                        param_final_df.loc[((param_final_df['Predicted_Status'].isin(['OB', 'SMB'])) & (
                                    param_final_df['PredictedComment'] != '') & (
                                                        param_final_df['ML_flag'] == 'ML')), 'ActionType'] = 'COMMENT'
                        param_final_df.loc[((param_final_df['Predicted_Status'] == 'UCB') & (
                                    param_final_df['PredictedComment'] == '') & (
                                                        param_final_df['ML_flag'] == 'ML')), 'ActionType'] = 'CLOSE'
                        param_final_df.loc[((param_final_df['Predicted_Status'].isin(['UMB', 'UMR', 'UMT'])) & (
                                    param_final_df['PredictedComment'] == '') & (
                                                        param_final_df['ML_flag'] == 'ML')), 'ActionType'] = 'PAIR'
                        param_final_df.loc[((param_final_df['Predicted_Status'].isin(['UMB', 'UMR', 'UMT'])) & (
                                    param_final_df['PredictedComment'] != '') & (param_final_df[
                                                                                     'ML_flag'] == 'ML')), 'ActionType'] = 'PAIR WITH COMMENT'
                        ...
                        param_final_df.loc[((param_final_df['Predicted_Status'] == 'OB') & (
                                    param_final_df['PredictedComment'] == '') & (
                                                        param_final_df['ML_flag'] == 'ML')), 'ActionTypeCode'] = 6
                        param_final_df.loc[((param_final_df['Predicted_Status'] == 'OB') & (
                                    param_final_df['PredictedComment'] != '') & (
                                                        param_final_df['ML_flag'] == 'ML')), 'ActionTypeCode'] = 3
                        param_final_df.loc[((param_final_df['Predicted_Status'] == 'UCB') & (
                                    param_final_df['PredictedComment'] == '') & (
                                                        param_final_df['ML_flag'] == 'ML')), 'ActionTypeCode'] = 2
                        param_final_df.loc[((param_final_df['Predicted_Status'].isin(['UMB', 'UMR', 'UMT'])) & (
                                    param_final_df['PredictedComment'] == '') & (
                                                        param_final_df['ML_flag'] == 'ML')), 'ActionTypeCode'] = 1
                        param_final_df.loc[((param_final_df['Predicted_Status'].isin(['UMB', 'UMR', 'UMT'])) & (
                                    param_final_df['PredictedComment'] != '') & (
                                                        param_final_df['ML_flag'] == 'ML')), 'ActionTypeCode'] = 4
                    ...
                    def remove_single_breakid_from_string_column_value(fun_string_column_value,
                                                                       fun_string_single_breakid_to_remove):
                    ...
                    def clean_list_of_BreakID_to_form_insertable_into_db(fun_str_list):
                        ...
                        fun_str_list_to_str_values = fun_str_list_to_str_values.replace('{', '').replace('}',
                                                                                                         '').replace(
                            '\'', '').replace('[', '').replace(']', '')
                    ...
                    def remove_or_not_remove_BreakIDs_from_BreakID_and_FinalPredictedBreakID_columns(row):
                        if (row['len_intersection_set_of_BreakID_and_FinalPredictedBreak'] == 0):
                            return (clean_list_of_BreakID_to_form_insertable_into_db(row['BreakID']),
                                    clean_list_of_BreakID_to_form_insertable_into_db(row['Final_predicted_break']))
                        elif (row['len_intersection_set_of_BreakID_and_FinalPredictedBreak'] == 1):
                            strig_value_of_intersection_set_of_BreakID_and_FinalPredictedBreak = str(
                                row['intersection_set_of_BreakID_and_FinalPredictedBreak']).replace('{', '').replace(
                                '}', '').replace('\'', '')
                            print(row['Final_predicted_break'])
                            row['Final_predicted_break'] = remove_single_breakid_from_string_column_value(
                                fun_string_column_value=row['Final_predicted_break'],
                                fun_string_single_breakid_to_remove=strig_value_of_intersection_set_of_BreakID_and_FinalPredictedBreak)
                            return (clean_list_of_BreakID_to_form_insertable_into_db(row['BreakID']),
                                    clean_list_of_BreakID_to_form_insertable_into_db(row['Final_predicted_break']))
                        elif (row['len_intersection_set_of_BreakID_and_FinalPredictedBreak'] > 1):
                    ...
                    def UMB_and_SMB_duplication_issue_in_BreakID_and_FinalPredictedBreakID_columns(
                            fun_final_df_2):  # , fun_meo_df = None):
                        fun_final_df_2['set_Final_predicted_break'] = fun_final_df_2['Final_predicted_break'].apply(
                            lambda x: set(x.replace(' ', '').split(',')))
                        fun_final_df_2['set_BreakID'] = fun_final_df_2['BreakID'].apply(
                            lambda x: set(x.replace(' ', '').split(',')))
                        fun_final_df_2['intersection_set_of_BreakID_and_FinalPredictedBreak'] = fun_final_df_2.apply(
                            lambda row: set_intersection_of_two_columns(row), axis=1)
                        fun_final_df_2['union_set_of_BreakID_and_FinalPredictedBreak'] = fun_final_df_2.apply(
                            lambda row: set_union_of_two_columns(row), axis=1)
                        fun_final_df_2['len_intersection_set_of_BreakID_and_FinalPredictedBreak'] = fun_final_df_2[
                            'intersection_set_of_BreakID_and_FinalPredictedBreak'].apply(lambda x: len(x))
                        fun_final_df_2[['BreakID_new', 'Final_predicted_break_new']] = fun_final_df_2.apply(
                            lambda row: remove_or_not_remove_BreakIDs_from_BreakID_and_FinalPredictedBreakID_columns(
                                row), axis=1, result_type="expand")
                        return (fun_final_df_2)


                    umb_smb_duplication_issue_df = UMB_and_SMB_duplication_issue_in_BreakID_and_FinalPredictedBreakID_columns(
...
#                    filepaths_umb_smb_duplication_issue_df = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\umb_smb_duplication_issue_df_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                    ...
                    colums_for_final_df_2 = ['len_intersection_set_of_BreakID_and_FinalPredictedBreak', 'BreakID_new',
                                             'BusinessDate', 'Final_predicted_break_new', 'ML_flag', 'Predicted_Status',
                                             'Predicted_action', 'SetupID', 'SourceCombinationCode', 'TaskID',
                                             'probability_No_pair', 'probability_UMB', 'probability_UMR',
                                             'probability_UMT', 'Side1_UniqueIds', 'PredictedComment',
                                             'PredictedCategory', 'Side0_UniqueIds', 'ActionType', 'ActionTypeCode']
...
#                    filepaths_final_df_2_before_making_umt_from_umr = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_df_2_before_making_umt_from_umr_setup_' + setup_code + '_date_' + str(date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                    ...
                    def get_NetAmountDifference_for_Side01UniqueIds_from_Side0UniqueId_and_Side0UniqueId_column_apply_row(
                            fun_row, fun_meo_df):
                        side0_UniqueIds_list_str = [x.lstrip().rstrip() for x in
                                                    fun_row['Side0_UniqueIds'].replace('\' \'', '\',\'').replace('\'',
                                                                                                                 '').split(
                                                        ',')]
                        side1_UniqueIds_list_str = [x.lstrip().rstrip() for x in
                                                    fun_row['Side1_UniqueIds'].replace('\' \'', '\',\'').replace('\'',
                                                                                                                 '').split(
                                                        ',')]
                        lst_Net_Amount_Difference_for_side0_UniqueIds_list_str = list(
                            fun_meo_df[fun_meo_df['ViewData.Side0_UniqueIds'].isin(side0_UniqueIds_list_str)][
                                'ViewData.Accounting Net Amount'].unique())
                        lst_Net_Amount_Difference_for_side1_UniqueIds_list_str = list(
                            fun_meo_df[fun_meo_df['ViewData.Side1_UniqueIds'].isin(side1_UniqueIds_list_str)][
                                'ViewData.B-P Net Amount'].unique())
                        amount_diff_of_sum_of_side_0_1_lists = sum(
                            lst_Net_Amount_Difference_for_side0_UniqueIds_list_str) - sum(
                            lst_Net_Amount_Difference_for_side1_UniqueIds_list_str)
                        rounded_amount_diff_of_sum_of_side_0_1_lists = round(amount_diff_of_sum_of_side_0_1_lists, 3)
                        if (fun_row['Predicted_Status'] == 'UMR'):
                            if ((abs(rounded_amount_diff_of_sum_of_side_0_1_lists) >= 0.01) and (
                                    abs(rounded_amount_diff_of_sum_of_side_0_1_lists) <= 1.00)):
                                Predicted_Status_new = 'UMT'
                                Predicted_action_new = fun_row['Predicted_action'].replace('UMR', 'UMT')
                            else:
                                Predicted_Status_new = fun_row['Predicted_Status']
                        ...
                        return (
                        Predicted_Status_new, Predicted_action_new, rounded_amount_diff_of_sum_of_side_0_1_lists,
                        lst_Net_Amount_Difference_for_side0_UniqueIds_list_str,
                        lst_Net_Amount_Difference_for_side1_UniqueIds_list_str)

                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before getting NetAmountDifference')

                    final_df_2[['Predicted_Status_new', 'Predicted_action_new', 'Sum_of_Net_Amount_Difference',
                                'lst_Net_Amount_Difference_for_side0_UniqueIds',
                                'lst_Net_Amount_Difference_for_side1_UniqueIds']] = final_df_2.apply(lambda
                                                                                                         row: get_NetAmountDifference_for_Side01UniqueIds_from_Side0UniqueId_and_Side0UniqueId_column_apply_row(
                        fun_row=row, fun_meo_df=meo_df), axis=1, result_type="expand")
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After getting NetAmountDifference')

#                    filepaths_final_df_2_after_making_umt_from_umr = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_df_2_after_making_umt_from_umr_setup_' + setup_code + '_date_' + str(
#                        date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                    ...
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After dropping columns')

                    final_df_2.rename(columns={'Predicted_Status_new': 'Predicted_Status',
                                               'Predicted_action_new': 'Predicted_action'}, inplace=True)
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After renaming columns')

                    final_df_2.drop(
                        columns=['Sum_of_Net_Amount_Difference', 'lst_Net_Amount_Difference_for_side0_UniqueIds',
                                 'lst_Net_Amount_Difference_for_side1_UniqueIds'], axis=1, inplace=True)
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After renaming columns again')

                    final_df_2_copy_2 = final_df_2.copy()
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After making copy of final_df2')

                    final_df_2['BreakID'] = final_df_2['BreakID'].replace(', ', ',', regex=True)
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After replacing BreakID spaces')
                    final_df_2['Final_predicted_break'] = final_df_2['Final_predicted_break'].replace(', ', ',',
                                                                                                      regex=True)
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After replacing Final Predicted BreakID spaces')

                    final_df_2['ReconSetupName'] = 'Weiss Advisers Cash Recon'
                    final_df_2['ClientShortCode'] = 'Weiss Advisors'
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After making ReconSetupName and ClientShortCode columns')

                    today = date.today()
                    today_Y_m_d = today.strftime("%Y-%m-%d")
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After making today_y_m_d')
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str=str(final_df_2.shape[0]))
                    final_df_2['CreatedDate'] = today_Y_m_d
                    final_df_2['CreatedDate'] = pd.to_datetime(final_df_2['CreatedDate'])
                    final_df_2['CreatedDate'] = final_df_2['CreatedDate'].map(
                        lambda x: dt.datetime.strftime(x, '%Y-%m-%dT%H:%M:%SZ'))
                    final_df_2['CreatedDate'] = pd.to_datetime(final_df_2['CreatedDate'])
                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='After making CreatedDateColumns')

#                    filepaths_final_df_2 = '\\\\vitblrdevcons01\\Raman  Strategy ML 2.0\\All_Data\\' + client + '\\final_df_2_setup_' + setup_code + '_date_' + str(
#                        date_i) + '_TaskID_' + str(TaskID_z) + '.csv'
                    #                final_df_2.to_csv(filepaths_final_df_2)

                    Logger_obj.log_to_file(param_filename=log_filepath, param_log_str='Before deleting objects')
                    ...
                    final_df_2_without_UMR_Many_One_to_One_Many = final_df_2[
                        final_df_2['Predicted_action'] != 'UMR_One-Many_to_Many-One']
                    if (final_df_2_without_UMR_Many_One_to_One_Many.shape[0] != 0):
                        final_df_2_without_UMR_Many_One_to_One_Many['BreakID'] = \
                        final_df_2_without_UMR_Many_One_to_One_Many['BreakID'].astype(str)
                        final_df_2_without_UMR_Many_One_to_One_Many['Final_predicted_break'] = \
                        final_df_2_without_UMR_Many_One_to_One_Many['Final_predicted_break'].astype(str)
                        final_df_2_without_UMR_Many_One_to_One_Many['SourceCombinationCode'] = \
                        final_df_2_without_UMR_Many_One_to_One_Many['SourceCombinationCode'].astype(str)

                        data_dict_without_UMR_Many_One_to_One_Many = final_df_2_without_UMR_Many_One_to_One_Many.to_dict(
                            "records_final_1")
                        coll_1_for_writing_prediction_data.insert_many(data_dict_without_UMR_Many_One_to_One_Many)

                    final_df_2_with_UMR_Many_One_to_One_Many = final_df_2[
                        final_df_2['Predicted_action'].isin(['UMR_One-Many_to_Many-One', 'UMR_Many_to_Many'])]
                    if (final_df_2_with_UMR_Many_One_to_One_Many.shape[0] != 0):
                        final_df_2_with_UMR_Many_One_to_One_Many['BreakID'] = final_df_2_with_UMR_Many_One_to_One_Many[
                            'BreakID'].astype(str)
                        final_df_2_with_UMR_Many_One_to_One_Many['Final_predicted_break'] = \
                        final_df_2_with_UMR_Many_One_to_One_Many['Final_predicted_break'].astype(str)
                        final_df_2_with_UMR_Many_One_to_One_Many['BreakID'] = final_df_2_with_UMR_Many_One_to_One_Many[
                            'BreakID'].map(lambda x: x.lstrip('[').rstrip(']'))
                        final_df_2_with_UMR_Many_One_to_One_Many['Final_predicted_break'] = \
                        final_df_2_with_UMR_Many_One_to_One_Many['Final_predicted_break'].map(
                            lambda x: x.lstrip('[').rstrip(']'))
                        final_df_2_with_UMR_Many_One_to_One_Many['SourceCombinationCode'] = \
                        final_df_2_with_UMR_Many_One_to_One_Many['SourceCombinationCode'].astype(str)

                        data_dict_with_UMR_Many_One_to_One_Many = final_df_2_with_UMR_Many_One_to_One_Many.to_dict(
                            "records_final_2")
